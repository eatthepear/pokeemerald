...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_DARK_LONG_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_LONG_GRASS_SOUTH_EDGE || metatileBehavior == MB_DARK_LONG_GRASS_SOUTH_EDGE)
        return TRUE;
    else
        return FALSE;
}
