...
#define FLAG_HIDDEN_ITEM_ZONE2A_ORAN_BERRY	                 (FLAG_HIDDEN_ITEMS_START + 0x02)			
...
#define FLAG_HIDDEN_ITEM_ZONE10A_RED_SHARD1	                 (FLAG_HIDDEN_ITEMS_START + 0x1A)			
#define FLAG_HIDDEN_ITEM_ZONE10A_RED_SHARD2	                 (FLAG_HIDDEN_ITEMS_START + 0x1B)			
...
#define FLAG_ITEM_ZONE7A_NEST_BALL                                  0x3FE
...
#define FLAG_ITEM_ZONE8C_POTION                                     0x408
...
#define FLAG_IS_RARE_CANDY                          (SYSTEM_FLAGS + 0xB5)
#define FLAG_SMART_WILD_AI_ON                       (SYSTEM_FLAGS + 0xB6)
#define FLAG_DISABLE_CATCHING                       (SYSTEM_FLAGS + 0xB7)
#define FLAG_DISABLE_BAG                            (SYSTEM_FLAGS + 0xB8)
#define FLAG_FORCE_DOUBLE_WILD                      (SYSTEM_FLAGS + 0xB9)
#define FLAG_BOOSTED_IVS                            (SYSTEM_FLAGS + 0xBA)
#define FLAG_DOUBLE_EXP                             (SYSTEM_FLAGS + 0xBB)
