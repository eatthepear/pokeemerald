...
#define FLAG_ZONE10B_RECEIVED_LUCKY_EGG                   0x40
#define FLAG_ZONE11A_NUZLOCKE_BOUGHT_RUIN                 0x41
#define FLAG_HIDE_ZONE12A_CAMPER_PICNICKER                0x42
#define FLAG_ZONE13A_RECEIVED_UTILITY_UMBRELLA            0x43
#define FLAG_ZONE13B_RECEIVED_FLASHLIGHT                  0x44
#define FLAG_ZONE13C_NUZLOCKE_FOSSIL_RECEIVED             0x45
#define FLAG_ZONE13C_RECEIVED_ZOOM_LENS                   0x46
#define FLAG_ZONE13C_RECEIVED_APPLES                      0x47
#define FLAG_ZONE13C_RECEIVED_SWEETS                      0x48
#define FLAG_HIDE_ZONE17A_HEX_MANIAC                      0x49
#define FLAG_HIDE_ZONE17A_PORYGON                         0x4A
#define FLAG_HIDE_ZONE18A_PORYGON                         0x4B
#define FLAG_HIDE_ZONE18A_ZOE                             0x4C
#define FLAG_HIDE_ZONE18A_ELI                             0x4D
#define FLAG_HIDE_ZONE18A_DOLL                            0x4E
#define FLAG_HIDE_ZONE18A_PIRATES                         0x4F
#define FLAG_HIDE_ZONE18A_BOAT                            0x50
#define FLAG_HIDE_ZONE18B_ZOE                             0x51
#define FLAG_HIDE_ZONE18B_ELI                             0x52
#define FLAG_HIDE_ZONE19D_PIRATES                         0x53
#define FLAG_RECEIVED_ZONE21A_TM29                        0x54
#define FLAG_RECEIVED_ZONE21C_HAPPINY                     0x55
#define FLAG_HIDE_CAM_AND_PAM                             0x56
#define FLAG_RECEIVED_ZONE23A_TM31                        0x57
#define FLAG_RECEIVED_ZONE24A_TM34                        0x58
#define FLAG_RECEIVED_ZONE24B_TM35                        0x59
#define FLAG_HIDE_ZONE25L_COLRESS                         0x5A
#define FLAG_TIM_SUPER_POTION_INTRO                       0x5B
#define FLAG_ZONE_B1_PORYGON_1                            0x5C
#define FLAG_ZONE_B1_PORYGON_2                            0x5D
#define FLAG_ZONE_B1_PORYGON_3                            0x5E
#define FLAG_ZONE_B1_PORYGON_4                            0x5F
#define FLAG_ZONE_B1_PORYGON_5                            0x60
#define FLAG_RECEIVED_PORYGON                             0x61
...
#define FLAG_SETTINGS_MANDATORY_INCREASED           (SYSTEM_FLAGS + 0xAB) // Trainers that are optional on Default have this
#define FLAG_SETTINGS_MANDATORY_DECREASED           (SYSTEM_FLAGS + 0xAC) // Trainers that are now mandatory on Brutal have this
#define FLAG_SETTINGS_HARD_BATTLES                  (SYSTEM_FLAGS + 0xAD)
#define FLAG_SETTINGS_NO_IN_BATTLE_ITEMS            (SYSTEM_FLAGS + 0xAE)
#define FLAG_SETTINGS_NO_EVS                        (SYSTEM_FLAGS + 0xAF)
#define FLAG_SETTINGS_SINGLE_USE_TMS                (SYSTEM_FLAGS + 0xB0)
#define FLAG_SETTINGS_DECREASED_REWARDS             (SYSTEM_FLAGS + 0xB1)
#define FLAG_SETTINGS_NO_FARMING                    (SYSTEM_FLAGS + 0xB2)
#define FLAG_SETTINGS_REMOVE_HELPER_NPCS            (SYSTEM_FLAGS + 0xB3)
#define FLAG_SETTINGS_REMOVE_HIDDEN_ITEMS           (SYSTEM_FLAGS + 0xB4)
#define FLAG_SETTINGS_NERF_PP                       (SYSTEM_FLAGS + 0xB5)
#define FLAG_SETTINGS_DISABLE_RETIRE                (SYSTEM_FLAGS + 0xB6)
#define FLAG_SETTINGS_FULL_PREVIEW_ON               (SYSTEM_FLAGS + 0xB7)
#define FLAG_SETTINGS_EXP_ALL_ON                    (SYSTEM_FLAGS + 0xB8)
#define FLAG_SETTINGS_NO_WILD_EXP                   (SYSTEM_FLAGS + 0xB9)
#define FLAG_SETTINGS_NO_REVISITING_REWARDS         (SYSTEM_FLAGS + 0xBA)
