...
extern const u8 gText_Var1CantBeUsed[];
...
extern const u8 gText_EVO_LEVEL_NATURE_MIDNIGHT[];
extern const u8 gText_EVO_LEVEL_NATURE_MIDDAY[];
extern const u8 gText_EVO_LEVEL_NATURE_DUSK[];
...
extern const u8 gText_SaveMenuVanilla[];
