const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_WAITER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_WAITRESS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MIRAGES] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(WAITER, gTrainerFrontPic_Waiter, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(WAITRESS, gTrainerFrontPic_Waitress, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MIRAGES, gTrainerFrontPic_Mirages, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(FAIRY_TALE_GIRL, gTrainerFrontPic_FairyTaleGirl, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SOCIALITE, gTrainerFrontPic_Socialite, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BACKPACKER_F, gTrainerFrontPic_BackpackerF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(WORKER, gTrainerFrontPic_Worker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ICE_WORKER, gTrainerFrontPic_IceWorker, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(WAITER, gTrainerPalette_Waiter),
    TRAINER_PAL(WAITRESS, gTrainerPalette_Waitress),
    TRAINER_PAL(MIRAGES, gTrainerPalette_DomeAceTucker),
