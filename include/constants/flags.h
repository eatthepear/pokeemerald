...
#define FLAG_SETTINGS_SINGLE_USE_TMS                (SYSTEM_FLAGS + 0xB1)
#define FLAG_SETTINGS_DECREASED_REWARDS             (SYSTEM_FLAGS + 0xB2)
#define FLAG_SETTINGS_NO_FARMING                    (SYSTEM_FLAGS + 0xB3)
#define FLAG_SETTINGS_REMOVE_HELPER_NPCS            (SYSTEM_FLAGS + 0xB4)
#define FLAG_SETTINGS_REMOVE_HIDDEN_ITEMS           (SYSTEM_FLAGS + 0xB5)
#define FLAG_SETTINGS_NERF_PP                       (SYSTEM_FLAGS + 0xB6)
#define FLAG_SETTINGS_DISABLE_RETIRE                (SYSTEM_FLAGS + 0xB7)
#define FLAG_SETTINGS_FULL_PREVIEW_ON               (SYSTEM_FLAGS + 0xB8)
#define FLAG_SETTINGS_EXP_ALL_ON                    (SYSTEM_FLAGS + 0xB9)
#define FLAG_SETTINGS_NO_WILD_EXP                   (SYSTEM_FLAGS + 0xBA)
#define FLAG_SETTINGS_NO_REVISITING_REWARDS         (SYSTEM_FLAGS + 0xBB)
#define FLAG_SETTINGS_NUZLOCKE_ON                   (SYSTEM_FLAGS + 0xBC)
#define FLAG_SETTINGS_RANDOMIZER_ON                 (SYSTEM_FLAGS + 0xBD)
#define FLAG_SETTINGS_BRUTAL_ON                     (SYSTEM_FLAGS + 0xBE)
