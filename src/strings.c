...
const u8 gText_ContinueMenuZone[] = _("Next Zone");
const u8 gText_ContinueMenuDefaultVanillaMode[] =_("Default Vanilla");
const u8 gText_ContinueMenuBrutalVanillaMode[] =_("Brutal Vanilla");
const u8 gText_ContinueMenuDefaultNuzlockeMode[] =_("Default Nuzlocke");
const u8 gText_ContinueMenuBrutalNuzlockeMode[] =_("Brutal Nuzlocke");
