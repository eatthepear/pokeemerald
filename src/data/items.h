...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM02_HIDDEN_POWER] =
    {
        .name = _("TM02"),
        .itemId = ITEM_TM02_HIDDEN_POWER,
        .price = 2500,
    ...
    [ITEM_TM03_AERIAL_ACE] =
    {
        .name = _("TM03"),
        .itemId = ITEM_TM03_AERIAL_ACE,
        .price = 2500,
    ...
    [ITEM_TM07_DRAINING_KISS] =
    {
        .name = _("TM07"),
        .itemId = ITEM_TM07_DRAINING_KISS,
        .price = 2500,
    ...
    [ITEM_TM08_WATER_PULSE] =
    {
        .name = _("TM08"),
        .itemId = ITEM_TM08_WATER_PULSE,
        .price = 2500,
    ...
    [ITEM_TM16_STEEL_WING] =
    {
        .name = _("TM16"),
        .itemId = ITEM_TM16_STEEL_WING,
        .price = 3000,
    ...
    [ITEM_TM27_SLUDGE_BOMB] =
    {
        .name = _("TM27"),
        .itemId = ITEM_TM27_SLUDGE_BOMB,
        .price = 1000,
    ...
    [ITEM_TM29_BRICK_BREAK] =
    {
        .name = _("TM29"),
        .itemId = ITEM_TM29_BRICK_BREAK,
        .price = 2000,
