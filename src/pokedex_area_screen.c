...
{
    {MAPSEC_SKY_PILLAR,       0xFFFF},
    {MAPSEC_SEAFLOOR_CAVERN,  0xFFFF},
    {MAPSEC_ALTERING_CAVE,    0xFFFF},
    {MAPSEC_MIRAGE_TOWER,     0xFFFF},
    {MAPSEC_DESERT_UNDERPASS, 0xFFFF},
    {MAPSEC_ARTISAN_CAVE,     0xFFFF},
    {MAPSEC_NONE}
};
