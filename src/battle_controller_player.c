...
static void HandleInputChooseAction(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        case 3: // Bottom right
            ...
            {
                BtlController_EmitTwoReturnValues(BUFFER_B, B_ACTION_VIEW_ENEMY_PARTY, 0);
            }
            else
            {
    ...
    else if (B_ENABLE_DEBUG && gMain.newKeys & SELECT_BUTTON && FlagGet(FLAG_IS_DEBUGGING_SAVEFILE))
    {
