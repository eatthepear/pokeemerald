...
static const struct MenuAction MultichoiceList_LelouchNatures1[] =
{
    {gText_AttackMints},
    {gText_DefenseMints},
    {gText_SpAttackMints},
    {gText_SpDefenseMints},
    {gText_SpeedMints},
    {gText_NeutralMints},
};
...
static const struct MenuAction MultichoiceList_Difficulty[] =
{
    {gText_Default},
    {gText_Brutal},
    {gText_Infinite},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_DIFFICULTY]                 = MULTICHOICE(MultichoiceList_Difficulty),
    ...
    [MULTI_LELOUCH_NATURES1]           = MULTICHOICE(MultichoiceList_LelouchNatures1),
...
const u8 *const gStdStrings[] =
{
    ...
    [STDSTRING_CONSUMABLES] = gText_Consumables,
};
