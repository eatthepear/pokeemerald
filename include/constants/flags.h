...
#define FLAG_HARDER_BATTLES            (SYSTEM_FLAGS + 0xAA)
#define FLAG_MANDATORY_BATTLES_INCREASED                        (SYSTEM_FLAGS + 0xAB)
#define FLAG_NO_EVS                      (SYSTEM_FLAGS + 0xAC)
#define FLAG_TM_SINGLE_USE                         (SYSTEM_FLAGS + 0xAD)
#define FLAG_DECREASED_TRAINER_REWARD                         (SYSTEM_FLAGS + 0xAE)
#define FLAG_NO_FARMING                      (SYSTEM_FLAGS + 0xAF)
#define FLAG_REMOVE_HELPER_NPCS                   (SYSTEM_FLAGS + 0xB0)
#define FLAG_DISABLE_HIDDEN_ITEMS                  (SYSTEM_FLAGS + 0xB1)
#define FLAG_INCREASED_PP_USAGE                     (SYSTEM_FLAGS + 0xB2)
#define FLAG_NO_RETIRE                            (SYSTEM_FLAGS + 0xB3)
#define FLAG_FULL_PREVIEW_ON                        (SYSTEM_FLAGS + 0xB4)
#define FLAG_EXP_ALL_ON                             (SYSTEM_FLAGS + 0xB5)
#define FLAG_NO_WILD_EXP                         (SYSTEM_FLAGS + 0xB6)
#define FLAG_NO_BATTLES_AFTER_LEAVE                       (SYSTEM_FLAGS + 0xB7)
#define FLAG_UNUSED_0x9B8                       (SYSTEM_FLAGS + 0xB8)
#define FLAG_UNUSED_0x9B9                           (SYSTEM_FLAGS + 0xB9)
#define FLAG_UNUSED_0x9BA                      (SYSTEM_FLAGS + 0xBA)
#define FLAG_UNUSED_0x9BB                            (SYSTEM_FLAGS + 0xBB)
