...
const u8 gText_ThisIsAPokemon[] = _("This is {COLOR BLUE}Quentin{COLOR DARK_GREY}, my Porygon.{PAUSE 96}\p");
...
const u8 gText_TrainingService[] = _("{COLOR RED}Training");
const u8 gText_MoveReminderService[] = _("{COLOR BLUE}Move Reminder");
const u8 gText_MoveTutorService[] = _("{COLOR GREEN}Move Tutor");
const u8 gText_OtherService[] = _("{COLOR YELLOW}Other");
