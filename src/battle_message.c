...
static const u8 sText_CriticalHit[] = _("{COLOR RED}A critical hit!");
...
static const u8 sText_CoinsScattered[] = _("Your Pokémon gained Exp. Points!\p");
...
static const u8 sText_WallyUsedItem[] = _("Add {STR_VAR_1} to your party and\nsend a party member to the PC?");
...
static const u8 sText_Lanettes[] = _("Colress's");
