...
const u8 gText_ContinueMenuVanilla[] =_("Mode: Vanilla");
const u8 gText_ContinueMenuRandomizer[] =_("Mode: Randomizer");
const u8 gText_ContinueMenuNuzlocke[] =_("Mode: Nuzlocke");
const u8 gText_ContinueMenuRandomlocke[] =_("Mode: Randomlocke");
const u8 gText_ContinueMenuDefault[] =_("Difficulty: Default");
const u8 gText_ContinueMenuBrutal[] =_("Difficulty: Brutal");
const u8 gText_ContinueMenuInfinite[] =_("Difficulty: Infinite");
