...
#define FLAG_HIDE_ZONE5B_SHINY_PORYGON                    0x2D
#define FLAG_LELOUCH_SHARDS_INTRO                         0x2E
#define FLAG_HIDE_ZONE6A_MAX                              0x2F
#define FLAG_ZONE7A_RECEIVED_WHIPPED_DREAM                0x30
#define FLAG_ZONE7A_RECEIVED_SACHET                       0x31
#define FLAG_HIDE_ZONE7A_MAX                              0x32
#define FLAG_ZONE7B_HEAL_USED                             0x33
#define FLAG_HIDE_ZONE8D_WALLY                            0x34
#define FLAG_HIDE_ZONE9A_ARI_WINSTRATE                    0x35
#define FLAG_HIDE_ZONE9A_BERTHA_WINSTRATE                 0x36
#define FLAG_HIDE_ZONE9A_CASSANDRA_WINSTRATE              0x37
#define FLAG_HIDE_ZONE9A_DOMINIC_WINSTRATE                0x38
#define FLAG_HIDE_ZONE9A_ERICA_WINSTRATE                  0x39
#define FLAG_ZONE9D_RECEIVED_MYSTIC_WATER                 0x3A
#define FLAG_ZONE9E_NUZLOCKE_BOUGHT_FARM_ANIMAL           0x3B
#define FLAG_ZONE10A_RECEIVED_SAFETY_GOGGLES              0x3C
#define FLAG_HIDE_ZONE10A_MAX                             0x3D
#define FLAG_ZONE10B_RECEIVED_TM21                        0x3E
#define FLAG_HIDE_ZONE10B_BERRYMAN                        0x3F
#define FLAG_HIDDEN_ITEM_ZONE10A_YELLOW_SHARD_1           0x40
#define FLAG_HIDDEN_ITEM_ZONE10A_YELLOW_SHARD_2           0x41
#define FLAG_HIDDEN_ITEM_ZONE10A_YELLOW_SHARD_3           0x42
#define FLAG_ZONE10B_RECEIVED_LUCKY_EGG                   0x43
#define FLAG_ZONE11A_NUZLOCKE_BOUGHT_RUIN                 0x44
#define FLAG_HIDE_ZONE12A_CAMPER_PICNICKER                0x45
#define FLAG_HIDE_ZONE12A_NURSE                           0x46
#define FLAG_ZONE13A_RECEIVED_UTILITY_UMBRELLA            0x47
#define FLAG_ZONE13B_RECEIVED_FLASHLIGHT                  0x48
#define FLAG_ZONE13C_NUZLOCKE_FOSSIL_RECEIVED             0x49
#define FLAG_ZONE13C_RECEIVED_ZOOM_LENS                   0x4A
#define FLAG_ZONE13C_RECEIVED_APPLES                      0x4B
#define FLAG_ZONE13C_RECEIVED_SWEETS                      0x4C
#define FLAG_HIDE_ZONE17A_HEX_MANIAC                      0x4D
#define FLAG_HIDE_ZONE17A_PORYGON                         0x4E
#define FLAG_HIDE_ZONE18A_PORYGON                         0x4F
#define FLAG_HIDE_ZONE18A_ZOE                             0x50
#define FLAG_HIDE_ZONE18A_ELI                             0x51
#define FLAG_HIDE_ZONE18A_DOLL                            0x52
#define FLAG_HIDE_ZONE18A_PIRATES                         0x53
#define FLAG_HIDE_ZONE18A_BOAT                            0x54
#define FLAG_HIDE_ZONE18A_MAX                             0x55
#define FLAG_HIDE_ZONE18B_ZOE                             0x56
#define FLAG_HIDE_ZONE18B_ELI                             0x57
#define FLAG_HIDE_ZONE19D_PIRATES                         0x58
#define FLAG_RECEIVED_ZONE21A_TM29                        0x59
#define FLAG_RECEIVED_ZONE21C_HAPPINY                     0x5A
#define FLAG_HIDE_CAM_AND_PAM                             0x5B
#define FLAG_RECEIVED_ZONE23A_TM31                        0x5C
#define FLAG_RECEIVED_ZONE24A_TM34                        0x5D
#define FLAG_RECEIVED_ZONE24B_TM35                        0x5E
#define FLAG_HIDE_ZONE25L_COLRESS                         0x5F
#define FLAG_TIM_SUPER_POTION_INTRO                       0x60
#define FLAG_ZONE_B1_PORYGON_1                            0x61
#define FLAG_ZONE_B1_PORYGON_2                            0x62
#define FLAG_ZONE_B1_PORYGON_3                            0x63
#define FLAG_ZONE_B1_PORYGON_4                            0x64
#define FLAG_ZONE_B1_PORYGON_5                            0x65
#define FLAG_RECEIVED_PORYGON                             0x66
...
#define FLAG_HIDDEN_ITEM_ZONE10A_RED_SHARD    	    	     (FLAG_HIDDEN_ITEMS_START + 0x1B)
#define FLAG_HIDDEN_ITEM_ZONE11A_SITRUS_BERRY	     	     (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_ZONE11A_CHERI_BERRY	      	     (FLAG_HIDDEN_ITEMS_START + 0x1D)
#define FLAG_HIDDEN_ITEM_ZONE11A_RAWST_BERRY	             (FLAG_HIDDEN_ITEMS_START + 0x1E)
#define FLAG_HIDDEN_ITEM_ZONE11A_PECHA_BERRY	             (FLAG_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_HIDDEN_ITEM_ZONE12A_LEPPA_BERRY	             (FLAG_HIDDEN_ITEMS_START + 0x20)
#define FLAG_HIDDEN_ITEM_ZONE12A_LUM_BERRY	                 (FLAG_HIDDEN_ITEMS_START + 0x21)
#define FLAG_HIDDEN_ITEM_ZONE12A_RED_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x22)
#define FLAG_HIDDEN_ITEM_ZONE12A_BLUE_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x23)
#define FLAG_HIDDEN_ITEM_ZONE13A_LUM_BERRY	                 (FLAG_HIDDEN_ITEMS_START + 0x24)
#define FLAG_HIDDEN_ITEM_ZONE14A_RED_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x25)
#define FLAG_HIDDEN_ITEM_ZONE14B_BLUE_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_ZONE14B_YELLOW_SHARD	             (FLAG_HIDDEN_ITEMS_START + 0x27)
#define FLAG_HIDDEN_ITEM_ZONE16A_RED_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_ZONE18A_SITRUS_BERRY	             (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_ZONE19B_BLUE_SHARD	                 (FLAG_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_HIDDEN_ITEM_ZONE19B_STARDUST	                 (FLAG_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_HIDDEN_ITEM_ZONE19B_PEARL	                     (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_ZONE19B_YELLOW_SHARD	             (FLAG_HIDDEN_ITEMS_START + 0x2D)
...
#define FLAG_SYS_NO_BAG_USE_IN_BATTLE               (SYSTEM_FLAGS + 0x88)
#define FLAG_SYS_NO_CATCHING                        (SYSTEM_FLAGS + 0x89)
#define FLAG_SYS_NO_BAG_START_MENU                  (SYSTEM_FLAGS + 0x8A)
#define FLAG_SYS_FORCE_DOUBLE_WILD                  (SYSTEM_FLAGS + 0x8B)
#define FLAG_SYS_SMART_WILD_AI_ON                   (SYSTEM_FLAGS + 0x8C)
#define FLAG_SYS_DEXNAV_GET                         (SYSTEM_FLAGS + 0x8D)
#define FLAG_SYS_DETECTOR_MODE                      (SYSTEM_FLAGS + 0x8E)
#define FLAG_SYS_DEXNAV_SEARCH                      (SYSTEM_FLAGS + 0x8F)
#define FLAG_FORCE_BATTLE_ANIM_ON                   (SYSTEM_FLAGS + 0x90)
#define FLAG_FORCE_BATTLE_ANIM_OFF                  (SYSTEM_FLAGS + 0x91)
#define FLAG_DISABLE_PREVIEW                        (SYSTEM_FLAGS + 0x92)
#define FLAG_DOING_TRAINING                         (SYSTEM_FLAGS + 0x93)
#define FLAG_IS_REVISITING_ZONE                     (SYSTEM_FLAGS + 0x94)
#define FLAG_IN_NEW_ZONE                            (SYSTEM_FLAGS + 0x95)
...
#define FLAG_SETTINGS_BRUTAL                        (SYSTEM_FLAGS + 0xAE)
#define FLAG_SETTINGS_NUZLOCKE                      (SYSTEM_FLAGS + 0xAF)
#define FLAG_SETTINGS_RANDOMIZER                    (SYSTEM_FLAGS + 0xB0)
#define FLAG_SETTINGS_INFINITE                      (SYSTEM_FLAGS + 0xB1)
#define FLAG_SETTINGS_FULL_SURVEIL                  (SYSTEM_FLAGS + 0xB2)
#define FLAG_SETTINGS_EXP_ALL                       (SYSTEM_FLAGS + 0xB3)
#define FLAG_SETTINGS_CHALLENGE                     (SYSTEM_FLAGS + 0xB4)
#define FLAG_SETTINGS_GAUNTLET                      (SYSTEM_FLAGS + 0xB5)
#define FLAG_SETTINGS_ANTIDOCTOR                    (SYSTEM_FLAGS + 0xB6)
#define FLAG_SETTINGS_CLUMSY                        (SYSTEM_FLAGS + 0xB7)
#define FLAG_SETTINGS_EFFORTLESS                    (SYSTEM_FLAGS + 0xB8)
#define FLAG_SETTINGS_RED_THUMB                     (SYSTEM_FLAGS + 0xB9)
#define FLAG_SETTINGS_LAZY                          (SYSTEM_FLAGS + 0xBA)
#define FLAG_SETTINGS_SINGLE_USE                    (SYSTEM_FLAGS + 0xBB)
#define FLAG_SETTINGS_POOR                          (SYSTEM_FLAGS + 0xBC)
#define FLAG_SETTINGS_INDEPENDENT                   (SYSTEM_FLAGS + 0xBD)
#define FLAG_SETTINGS_WORKAHOLIC                    (SYSTEM_FLAGS + 0xBE)
