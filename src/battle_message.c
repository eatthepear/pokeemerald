...
static const u8 sText_WildPkmnAppeared2[] = _("Leviathan {B_OPPONENT_MON1_NAME} appeared!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME} appeared!\p");
...
static const u8 sText_Lanettes[] = _("Jaya's");
