...
#define FLAG_SETTINGS_NO_IN_BATTLE_ITEMS            (SYSTEM_FLAGS + 0xAC)
#define FLAG_SETTINGS_HARD_BATTLES                  (SYSTEM_FLAGS + 0xAD)
#define FLAG_SETTINGS_MANDATORY_INCREASED           (SYSTEM_FLAGS + 0xAE)
...
#define FLAG_SETTINGS_INFINITE_RESOURCES_MODE_ON    (SYSTEM_FLAGS + 0xBB)
#define FLAG_SETTINGS_NUZLOCKE_MODE_ON              (SYSTEM_FLAGS + 0xBC)
#define FLAG_SETTINGS_RANDOMIZER_MODE_ON            (SYSTEM_FLAGS + 0xBD)
#define FLAG_SETTINGS_BRUTAL_DIFFICULTY_ON          (SYSTEM_FLAGS + 0xBE)
