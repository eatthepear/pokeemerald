...
static bool8 Task_ProcessSoundCheckMenuInput(u8 taskId) // sub_080E8688
{
    ...
    else if (JOY_REPEAT(DPAD_LEFT))
    {
        ...
        else
        {
            if (gTasks[taskId].tBgmIndex > 0)
                ...
                gTasks[taskId].tBgmIndex = (MUS_BW_SEQ_ME_KINOMI - (MUS_LITTLEROOT_TEST - 1));
        }
        return TRUE;
    }
    else if (JOY_REPEAT(DPAD_RIGHT))
    {
        ...
        {
            if (gTasks[taskId].tBgmIndex < (MUS_BW_SEQ_ME_KINOMI - (MUS_LITTLEROOT_TEST - 1)))
                gTasks[taskId].tBgmIndex++;
            else
                gTasks[taskId].tBgmIndex = 0;
        }
...
#define SOUND_LIST_BGM \
    ...
    X(MUS_DP_SEQ_TITLE00               , "DP-SEQ-TITLE00") \
    X(MUS_DP_SEQ_TITLE01               , "DP-SEQ-TITLE01") \
    X(MUS_DP_SEQ_OPENING               , "DP-SEQ-OPENING") \
    X(MUS_DP_SEQ_TV_HOUSOU             , "DP-SEQ-TV-HOUSOU") \
    X(MUS_DP_SEQ_TV_END                , "DP-SEQ-TV-END") \
    X(MUS_DP_SEQ_TOWN01_D              , "DP-SEQ-TOWN01-D") \
    X(MUS_DP_SEQ_TOWN01_N              , "DP-SEQ-TOWN01-N") \
    X(MUS_DP_SEQ_THE_RIV               , "DP-SEQ-THE-RIV") \
    X(MUS_DP_SEQ_ROAD_A_D              , "DP-SEQ-ROAD-A-D") \
    X(MUS_DP_SEQ_ROAD_A_N              , "DP-SEQ-ROAD-A-N") \
    X(MUS_DP_SEQ_D_LAKE                , "DP-SEQ-D-LAKE") \
    X(MUS_DP_SEQ_THE_EVENT01           , "DP-SEQ-THE-EVENT01") \
    X(MUS_DP_SEQ_BA_POKE               , "DP-SEQ-BA-POKE") \
    X(MUS_DP_SEQ_WINPOKE               , "DP-SEQ-WINPOKE") \
    X(MUS_DP_SEQ_THE_GIRL              , "DP-SEQ-THE-GIRL") \
    X(MUS_DP_SEQ_THE_BOY               , "DP-SEQ-THE-BOY") \
    X(MUS_DP_SEQ_FANFA4                , "DP-SEQ-FANFA4") \
    X(MUS_DP_SEQ_TOWN02_D              , "DP-SEQ-TOWN02-D") \
    X(MUS_DP_SEQ_TOWN02_N              , "DP-SEQ-TOWN02-N") \
    X(MUS_DP_SEQ_KENKYUJO              , "DP-SEQ-KENKYUJO") \
    X(MUS_DP_SEQ_TSURETEKE             , "DP-SEQ-TSURETEKE") \
    X(MUS_DP_SEQ_PC_01                 , "DP-SEQ-PC-01") \
    X(MUS_DP_SEQ_PC_02                 , "DP-SEQ-PC-02") \
    X(MUS_DP_SEQ_ASA                   , "DP-SEQ-ASA") \
    X(MUS_DP_SEQ_EYE_BOY               , "DP-SEQ-EYE-BOY") \
    X(MUS_DP_SEQ_EYE_GIRL              , "DP-SEQ-EYE-GIRL") \
    X(MUS_DP_SEQ_BA_TRAIN              , "DP-SEQ-BA-TRAIN") \
    X(MUS_DP_SEQ_WINTRAIN              , "DP-SEQ-WINTRAIN") \
    X(MUS_DP_SEQ_CITY01_D              , "DP-SEQ-CITY01-D") \
    X(MUS_DP_SEQ_CITY01_N              , "DP-SEQ-CITY01-N") \
    X(MUS_DP_SEQ_FANFA3                , "DP-SEQ-FANFA3") \
    X(MUS_DP_SEQ_FS                    , "DP-SEQ-FS") \
    X(MUS_DP_SEQ_ROAD_B_D              , "DP-SEQ-ROAD-B-D") \
    X(MUS_DP_SEQ_ROAD_B_N              , "DP-SEQ-ROAD-B-N") \
    X(MUS_DP_SEQ_BA_RIVAL              , "DP-SEQ-BA-RIVAL") \
    X(MUS_DP_SEQ_D_05                  , "DP-SEQ-D-05") \
    X(MUS_DP_SEQ_WAZA                  , "DP-SEQ-WAZA") \
    X(MUS_DP_SEQ_CITY03_D              , "DP-SEQ-CITY03-D") \
    X(MUS_DP_SEQ_CITY03_N              , "DP-SEQ-CITY03-N") \
    X(MUS_DP_SEQ_D_04                  , "DP-SEQ-D-04") \
    X(MUS_DP_SEQ_GYM                   , "DP-SEQ-GYM") \
    X(MUS_DP_SEQ_BA_GYM                , "DP-SEQ-BA-GYM") \
    X(MUS_DP_SEQ_WINTGYM               , "DP-SEQ-WINTGYM") \
    X(MUS_DP_SEQ_BADGE                 , "DP-SEQ-BADGE") \
    X(MUS_DP_SEQ_EYE_KID               , "DP-SEQ-EYE-KID") \
    X(MUS_DP_SEQ_FANFA1                , "DP-SEQ-FANFA1") \
    X(MUS_DP_SEQ_TOWN03_D              , "DP-SEQ-TOWN03-D") \
    X(MUS_DP_SEQ_TOWN03_N              , "DP-SEQ-TOWN03-N") \
    X(MUS_DP_SEQ_KINOMI                , "DP-SEQ-KINOMI") \
    X(MUS_DP_SEQ_ROAD_C_D              , "DP-SEQ-ROAD-C-D") \
    X(MUS_DP_SEQ_ROAD_C_N              , "DP-SEQ-ROAD-C-N") \
    X(MUS_DP_SEQ_EYE_GINGA             , "DP-SEQ-EYE-GINGA") \
    X(MUS_DP_SEQ_BA_GINGA              , "DP-SEQ-BA-GINGA") \
    X(MUS_DP_SEQ_D_02                  , "DP-SEQ-D-02") \
    X(MUS_DP_SEQ_GONIN                 , "DP-SEQ-GONIN") \
    X(MUS_DP_SEQ_CITY04_D              , "DP-SEQ-CITY04-D") \
    X(MUS_DP_SEQ_CITY04_N              , "DP-SEQ-CITY04-N") \
    X(MUS_DP_SEQ_D_GINLOBBY            , "DP-SEQ-D-GINLOBBY") \
    X(MUS_DP_SEQ_BA_GINGA3             , "DP-SEQ-BA-GINGA3") \
    X(MUS_DP_SEQ_WINGINGA              , "DP-SEQ-WINGINGA") \
    X(MUS_DP_SEQ_SHINKA                , "DP-SEQ-SHINKA") \
    X(MUS_DP_SEQ_FANFA5                , "DP-SEQ-FANFA5") \
    X(MUS_DP_SEQ_BICYCLE               , "DP-SEQ-BICYCLE") \
    X(MUS_DP_SEQ_EYE_SPORT             , "DP-SEQ-EYE-SPORT") \
    X(MUS_DP_SEQ_ROAD_D_D              , "DP-SEQ-ROAD-D-D") \
    X(MUS_DP_SEQ_ROAD_D_N              , "DP-SEQ-ROAD-D-N") \
    X(MUS_DP_SEQ_CITY05_D              , "DP-SEQ-CITY05-D") \
    X(MUS_DP_SEQ_CITY05_N              , "DP-SEQ-CITY05-N") \
    X(MUS_DP_SEQ_ROAD_E_D              , "DP-SEQ-ROAD-E-D") \
    X(MUS_DP_SEQ_ROAD_E_N              , "DP-SEQ-ROAD-E-N") \
    X(MUS_DP_SEQ_EYE_MOUNT             , "DP-SEQ-EYE-MOUNT") \
    X(MUS_DP_SEQ_TOWN04_D              , "DP-SEQ-TOWN04-D") \
    X(MUS_DP_SEQ_TOWN04_N              , "DP-SEQ-TOWN04-N") \
    X(MUS_DP_SEQ_POCKETCH              , "DP-SEQ-POCKETCH") \
    X(MUS_DP_SEQ_ROAD_F_D              , "DP-SEQ-ROAD-F-D") \
    X(MUS_DP_SEQ_ROAD_F_N              , "DP-SEQ-ROAD-F-N") \
    X(MUS_DP_SEQ_CITY07_D              , "DP-SEQ-CITY07-D") \
    X(MUS_DP_SEQ_CITY07_N              , "DP-SEQ-CITY07-N") \
    X(MUS_DP_SEQ_TOWN07_D              , "DP-SEQ-TOWN07-D") \
    X(MUS_DP_SEQ_TOWN07_N              , "DP-SEQ-TOWN07-N") \
    X(MUS_DP_SEQ_CITY02_D              , "DP-SEQ-CITY02-D") \
    X(MUS_DP_SEQ_CITY02_N              , "DP-SEQ-CITY02-N") \
    X(MUS_DP_SEQ_ROAD_SNOW_D           , "DP-SEQ-ROAD-SNOW-D") \
    X(MUS_DP_SEQ_ROAD_SNOW_N           , "DP-SEQ-ROAD-SNOW-N") \
    X(MUS_DP_SEQ_CITY09_D              , "DP-SEQ-CITY09-D") \
    X(MUS_DP_SEQ_CITY09_N              , "DP-SEQ-CITY09-N") \
    X(MUS_DP_SEQ_D_AGITO               , "DP-SEQ-D-AGITO") \
    X(MUS_DP_SEQ_BA_AGAKI              , "DP-SEQ-BA-AGAKI") \
    X(MUS_DP_SEQ_THE_EVENT04           , "DP-SEQ-THE-EVENT04") \
    X(MUS_DP_SEQ_D_MOUNT1              , "DP-SEQ-D-MOUNT1") \
    X(MUS_DP_SEQ_D_MOUNT2              , "DP-SEQ-D-MOUNT2") \
    X(MUS_DP_SEQ_THE_EVENT02           , "DP-SEQ-THE-EVENT02") \
    X(MUS_DP_SEQ_THE_EVENT03           , "DP-SEQ-THE-EVENT03") \
    X(MUS_DP_SEQ_BA_DPOKE2             , "DP-SEQ-BA-DPOKE2") \
    X(MUS_DP_SEQ_CITY08_D              , "DP-SEQ-CITY08-D") \
    X(MUS_DP_SEQ_CITY08_N              , "DP-SEQ-CITY08-N") \
    X(MUS_DP_SEQ_D_01                  , "DP-SEQ-D-01") \
    X(MUS_DP_SEQ_EYE_ELITE             , "DP-SEQ-EYE-ELITE") \
    X(MUS_DP_SEQ_CITY10_D              , "DP-SEQ-CITY10-D") \
    X(MUS_DP_SEQ_CITY10_N              , "DP-SEQ-CITY10-N") \
    X(MUS_DP_SEQ_CITY11_D              , "DP-SEQ-CITY11-D") \
    X(MUS_DP_SEQ_CITY11_N              , "DP-SEQ-CITY11-N") \
    X(MUS_DP_SEQ_TOWN06_D              , "DP-SEQ-TOWN06-D") \
    X(MUS_DP_SEQ_TOWN06_N              , "DP-SEQ-TOWN06-N") \
    X(MUS_DP_SEQ_ROAD_BZA_D            , "DP-SEQ-ROAD-BZA-D") \
    X(MUS_DP_SEQ_ROAD_BZA_N            , "DP-SEQ-ROAD-BZA-N") \
    X(MUS_DP_SEQ_WIFILOBBY             , "DP-SEQ-WIFILOBBY") \
    X(MUS_DP_SEQ_BLD_TV                , "DP-SEQ-BLD-TV") \
    X(MUS_DP_SEQ_BLD_BLD_GTC           , "DP-SEQ-BLD-BLD-GTC") \
    X(MUS_DP_SEQ_NAMINORI              , "DP-SEQ-NAMINORI") \
    X(MUS_DP_SEQ_WASURE                , "DP-SEQ-WASURE") \
    X(MUS_DP_SEQ_EYE_FIGHT             , "DP-SEQ-EYE-FIGHT") \
    X(MUS_DP_SEQ_EYE_ENKA              , "DP-SEQ-EYE-ENKA") \
    X(MUS_DP_SEQ_TANKOU                , "DP-SEQ-TANKOU") \
    X(MUS_DP_SEQ_HATANIGE              , "DP-SEQ-HATANIGE") \
    X(MUS_DP_SEQ_EYE_LADY              , "DP-SEQ-EYE-LADY") \
    X(MUS_DP_SEQ_D_03                  , "DP-SEQ-D-03") \
    X(MUS_DP_SEQ_D_SAFARI              , "DP-SEQ-D-SAFARI") \
    X(MUS_DP_SEQ_EYE_MYS               , "DP-SEQ-EYE-MYS") \
    X(MUS_DP_SEQ_BLD_GAME              , "DP-SEQ-BLD-GAME") \
    X(MUS_DP_SEQ_SLOT_ATARI            , "DP-SEQ-SLOT-ATARI") \
    X(MUS_DP_SEQ_SLOT_OOATARI          , "DP-SEQ-SLOT-OOATARI") \
    X(MUS_DP_SEQ_EYE_RICH              , "DP-SEQ-EYE-RICH") \
    X(MUS_DP_SEQ_D_RYAYHY              , "DP-SEQ-D-RYAYHY") \
    X(MUS_DP_SEQ_BA_DPOKE1             , "DP-SEQ-BA-DPOKE1") \
    X(MUS_DP_SEQ_KUSAGASA              , "DP-SEQ-KUSAGASA") \
    X(MUS_DP_SEQ_EYE_FUN               , "DP-SEQ-EYE-FUN") \
    X(MUS_DP_SEQ_D_KOUEN               , "DP-SEQ-D-KOUEN") \
    X(MUS_DP_SEQ_ACCE                  , "DP-SEQ-ACCE") \
    X(MUS_DP_SEQ_BLD_CON               , "DP-SEQ-BLD-CON") \
    X(MUS_DP_SEQ_KINOMI1               , "DP-SEQ-KINOMI1") \
    X(MUS_DP_SEQ_CON_TEST              , "DP-SEQ-CON-TEST") \
    X(MUS_DP_SEQ_CO_DRESS              , "DP-SEQ-CO-DRESS") \
    X(MUS_DP_SEQ_CO_KASHI              , "DP-SEQ-CO-KASHI") \
    X(MUS_DP_SEQ_CO_TAKUMA             , "DP-SEQ-CO-TAKUMA") \
    X(MUS_DP_SEQ_CO_KEKKA              , "DP-SEQ-CO-KEKKA") \
    X(MUS_DP_SEQ_CO_FANFA              , "DP-SEQ-CO-FANFA") \
    X(MUS_DP_SEQ_BF_TOWWER             , "DP-SEQ-BF-TOWWER") \
    X(MUS_DP_SEQ_D_06                  , "DP-SEQ-D-06") \
    X(MUS_DP_SEQ_BA_SECRET2            , "DP-SEQ-BA-SECRET2") \
    X(MUS_DP_SEQ_PRESENT               , "DP-SEQ-PRESENT") \
    X(MUS_DP_SEQ_D_LEAGUE              , "DP-SEQ-D-LEAGUE") \
    X(MUS_DP_SEQ_EYE_TENNO             , "DP-SEQ-EYE-TENNO") \
    X(MUS_DP_SEQ_BA_TENNO              , "DP-SEQ-BA-TENNO") \
    X(MUS_DP_SEQ_WINTENNO              , "DP-SEQ-WINTENNO") \
    X(MUS_DP_SEQ_EYE_CHAMP             , "DP-SEQ-EYE-CHAMP") \
    X(MUS_DP_SEQ_BA_CHANP              , "DP-SEQ-BA-CHANP") \
    X(MUS_DP_SEQ_WINCHAMP              , "DP-SEQ-WINCHAMP") \
    X(MUS_DP_SEQ_BLD_DENDO             , "DP-SEQ-BLD-DENDO") \
    X(MUS_DP_SEQ_BLD_EV_DENDO2         , "DP-SEQ-BLD-EV-DENDO2") \
    X(MUS_DP_SEQ_BLD_ENDING            , "DP-SEQ-BLD-ENDING") \
    X(MUS_DP_SEQ_FUE                   , "DP-SEQ-FUE") \
    X(MUS_DP_SEQ_AUS                   , "DP-SEQ-AUS") \
    X(MUS_DP_SEQ_BA_SECRET1            , "DP-SEQ-BA-SECRET1") \
    X(MUS_PL_SEQ_TITLE00               , "PL-SEQ-TITLE00") \
    X(MUS_PL_SEQ_TITLE01               , "PL-SEQ-TITLE01") \
    X(MUS_PL_SEQ_TV_HOUSOU             , "PL-SEQ-TV-HOUSOU") \
    X(MUS_PL_SEQ_TV_END                , "PL-SEQ-TV-END") \
    X(MUS_PL_SEQ_PL_HANDSOME           , "PL-SEQ-PL-HANDSOME") \
    X(MUS_PL_SEQ_PL_WIFITOWER          , "PL-SEQ-PL-WIFITOWER") \
    X(MUS_PL_SEQ_PL_WIFIUNION          , "PL-SEQ-PL-WIFIUNION") \
    X(MUS_PL_SEQ_PL_WIFIGAME           , "PL-SEQ-PL-WIFIGAME") \
    X(MUS_PL_SEQ_PL_WINMINI2           , "PL-SEQ-PL-WINMINI2") \
    X(MUS_PL_SEQ_PL_WIFIPARADE         , "PL-SEQ-PL-WIFIPARADE") \
    X(MUS_PL_SEQ_PL_EV_GIRA            , "PL-SEQ-PL-EV-GIRA") \
    X(MUS_PL_SEQ_PL_EV_GIRA2           , "PL-SEQ-PL-EV-GIRA2") \
    X(MUS_PL_SEQ_PL_D_GIRATINA         , "PL-SEQ-PL-D-GIRATINA") \
    X(MUS_PL_SEQ_PL_BA_GIRA            , "PL-SEQ-PL-BA-GIRA") \
    X(MUS_PL_SEQ_PL_GURUGURU           , "PL-SEQ-PL-GURUGURU") \
    X(MUS_PL_SEQ_PL_PTHAIFU            , "PL-SEQ-PL-PTHAIFU") \
    X(MUS_PL_SEQ_PL_MTKAWA             , "PL-SEQ-PL-MTKAWA") \
    X(MUS_PL_SEQ_PL_MTKAKKO            , "PL-SEQ-PL-MTKAKKO") \
    X(MUS_PL_SEQ_PL_MTTAKMA            , "PL-SEQ-PL-MTTAKMA") \
    X(MUS_PL_SEQ_PL_MTUTSUK            , "PL-SEQ-PL-MTUTSUK") \
    X(MUS_PL_SEQ_PL_MTKASHI            , "PL-SEQ-PL-MTKASHI") \
    X(MUS_PL_SEQ_PL_TOWN02             , "PL-SEQ-PL-TOWN02") \
    X(MUS_PL_SEQ_PL_AUDIO              , "PL-SEQ-PL-AUDIO") \
    X(MUS_PL_SEQ_CITY11_D              , "PL-SEQ-CITY11-D") \
    X(MUS_PL_SEQ_PL_BF_ROULETTE        , "PL-SEQ-PL-BF-ROULETTE") \
    X(MUS_PL_SEQ_PL_DON2               , "PL-SEQ-PL-DON2") \
    X(MUS_PL_SEQ_PL_BF_STAGE           , "PL-SEQ-PL-BF-STAGE") \
    X(MUS_PL_SEQ_PL_BF_FACTORY         , "PL-SEQ-PL-BF-FACTORY") \
    X(MUS_PL_SEQ_PL_BF_CASTLE          , "PL-SEQ-PL-BF-CASTLE") \
    X(MUS_PL_SEQ_PL_FRO                , "PL-SEQ-PL-FRO") \
    X(MUS_PL_SEQ_PL_POINTGET3          , "PL-SEQ-PL-POINTGET3") \
    X(MUS_PL_SEQ_PL_BA_BRAIN           , "PL-SEQ-PL-BA-BRAIN") \
    X(MUS_PL_SEQ_PL_WINBRAIN           , "PL-SEQ-PL-WINBRAIN") \
    X(MUS_PL_SEQ_PL_BA_REGI            , "PL-SEQ-PL-BA-REGI") \
    X(MUS_HG_SEQ_GS_TITLE              , "HG-SEQ-GS-TITLE") \
    X(MUS_HG_SEQ_GS_POKEMON_THEME      , "HG-SEQ-GS-POKEMON-THEME") \
    X(MUS_HG_SEQ_GS_STARTING           , "HG-SEQ-GS-STARTING") \
    X(MUS_HG_SEQ_GS_T_WAKABA           , "HG-SEQ-GS-T-WAKABA") \
    X(MUS_HG_SEQ_GS_E_TSURETEKE1       , "HG-SEQ-GS-E-TSURETEKE1") \
    X(MUS_HG_SEQ_GS_E_SUPPORT_F        , "HG-SEQ-GS-E-SUPPORT-F") \
    X(MUS_HG_SEQ_GS_E_SUPPORT_M        , "HG-SEQ-GS-E-SUPPORT-M") \
    X(MUS_HG_SEQ_GS_UTSUGI_RABO        , "HG-SEQ-GS-UTSUGI-RABO") \
    X(MUS_HG_SEQ_ME_KEYITEM            , "HG-SEQ-ME-KEYITEM") \
    X(MUS_HG_SEQ_GS_R_1_29             , "HG-SEQ-GS-R-1-29") \
    X(MUS_HG_SEQ_GS_VS_NORAPOKE        , "HG-SEQ-GS-VS-NORAPOKE") \
    X(MUS_HG_SEQ_GS_WIN2               , "HG-SEQ-GS-WIN2") \
    X(MUS_HG_SEQ_GS_WIN2_NOT_FAN       , "HG-SEQ-GS-WIN2-NOT-FAN") \
    X(MUS_HG_SEQ_ME_LVUP               , "HG-SEQ-ME-LVUP") \
    X(MUS_HG_SEQ_GS_C_YOSHINO          , "HG-SEQ-GS-C-YOSHINO") \
    X(MUS_HG_SEQ_GS_E_TSURETEKE2       , "HG-SEQ-GS-E-TSURETEKE2") \
    X(MUS_HG_SEQ_GS_POKESEN            , "HG-SEQ-GS-POKESEN") \
    X(MUS_HG_SEQ_ME_ASA                , "HG-SEQ-ME-ASA") \
    X(MUS_HG_SEQ_GS_EYE_J_SHOUNEN      , "HG-SEQ-GS-EYE-J-SHOUNEN") \
    X(MUS_HG_SEQ_GS_VS_TRAINER         , "HG-SEQ-GS-VS-TRAINER") \
    X(MUS_HG_SEQ_GS_WIN1               , "HG-SEQ-GS-WIN1") \
    X(MUS_HG_SEQ_GS_R_1_30             , "HG-SEQ-GS-R-1-30") \
    X(MUS_HG_SEQ_ME_HYOUKA1            , "HG-SEQ-ME-HYOUKA1") \
    X(MUS_HG_SEQ_GS_C_KIKYOU           , "HG-SEQ-GS-C-KIKYOU") \
    X(MUS_HG_SEQ_GS_TO_MADATSUBOMI1    , "HG-SEQ-GS-TO-MADATSUBOMI1") \
    X(MUS_HG_SEQ_GS_EYE_BOUZU          , "HG-SEQ-GS-EYE-BOUZU") \
    X(MUS_HG_SEQ_GS_FS                 , "HG-SEQ-GS-FS") \
    X(MUS_HG_SEQ_ME_TAMAGO_GET         , "HG-SEQ-ME-TAMAGO-GET") \
    X(MUS_HG_SEQ_GS_E_MAIKO_THEME      , "HG-SEQ-GS-E-MAIKO-THEME") \
    X(MUS_HG_SEQ_GS_D_CHIKATSUURO      , "HG-SEQ-GS-D-CHIKATSUURO") \
    X(MUS_HG_SEQ_ME_ITEM               , "HG-SEQ-ME-ITEM") \
    X(MUS_HG_SEQ_GS_D_UNKNOWN_ISEKI    , "HG-SEQ-GS-D-UNKNOWN-ISEKI") \
    X(MUS_HG_SEQ_GS_RADIO_UNKNOWN      , "HG-SEQ-GS-RADIO-UNKNOWN") \
    X(MUS_HG_SEQ_ME_HYOUKA2            , "HG-SEQ-ME-HYOUKA2") \
    X(MUS_HG_SEQ_GS_T_HIWADA           , "HG-SEQ-GS-T-HIWADA") \
    X(MUS_HG_SEQ_GS_EYE_ROCKET         , "HG-SEQ-GS-EYE-ROCKET") \
    X(MUS_HG_SEQ_GS_VS_ROCKET          , "HG-SEQ-GS-VS-ROCKET") \
    X(MUS_HG_SEQ_GS_R_4_34             , "HG-SEQ-GS-R-4-34") \
    X(MUS_HG_SEQ_GS_E_RIVAL1           , "HG-SEQ-GS-E-RIVAL1") \
    X(MUS_HG_SEQ_GS_VS_RIVAL           , "HG-SEQ-GS-VS-RIVAL") \
    X(MUS_HG_SEQ_GS_SHINKA             , "HG-SEQ-GS-SHINKA") \
    X(MUS_HG_SEQ_GS_KOUKAN             , "HG-SEQ-GS-KOUKAN") \
    X(MUS_HG_SEQ_ME_SHINKAOME          , "HG-SEQ-ME-SHINKAOME") \
    X(MUS_HG_SEQ_GS_C_KOGANE           , "HG-SEQ-GS-C-KOGANE") \
    X(MUS_HG_SEQ_GS_GYM                , "HG-SEQ-GS-GYM") \
    X(MUS_HG_SEQ_GS_VS_GYMREADER       , "HG-SEQ-GS-VS-GYMREADER") \
    X(MUS_HG_SEQ_GS_WIN3               , "HG-SEQ-GS-WIN3") \
    X(MUS_HG_SEQ_ME_BADGE              , "HG-SEQ-ME-BADGE") \
    X(MUS_HG_SEQ_GS_RADIO_JINGLE       , "HG-SEQ-GS-RADIO-JINGLE") \
    X(MUS_HG_SEQ_GS_AIKOTOBA           , "HG-SEQ-GS-AIKOTOBA") \
    X(MUS_HG_SEQ_ME_WAZA               , "HG-SEQ-ME-WAZA") \
    X(MUS_HG_SEQ_GS_GAME               , "HG-SEQ-GS-GAME") \
    X(MUS_HG_SEQ_GS_GAMEATARI          , "HG-SEQ-GS-GAMEATARI") \
    X(MUS_HG_SEQ_ME_CARDGAME1          , "HG-SEQ-ME-CARDGAME1") \
    X(MUS_HG_SEQ_ME_CARDGAME2          , "HG-SEQ-ME-CARDGAME2") \
    X(MUS_HG_SEQ_ME_ACCE               , "HG-SEQ-ME-ACCE") \
    X(MUS_HG_SEQ_GS_WIFITOWER          , "HG-SEQ-GS-WIFITOWER") \
    X(MUS_HG_SEQ_GS_BLD_GTC            , "HG-SEQ-GS-BLD-GTC") \
    X(MUS_HG_SEQ_ME_HYOUKA3            , "HG-SEQ-ME-HYOUKA3") \
    X(MUS_HG_SEQ_PL_BICYCLE            , "HG-SEQ-PL-BICYCLE") \
    X(MUS_HG_SEQ_GS_EYE_J_SHOUJO       , "HG-SEQ-GS-EYE-J-SHOUJO") \
    X(MUS_HG_SEQ_ME_POKEGEAR_REGIST    , "HG-SEQ-ME-POKEGEAR-REGIST") \
    X(MUS_HG_SEQ_GS_D_KOUEN            , "HG-SEQ-GS-D-KOUEN") \
    X(MUS_HG_SEQ_ME_KINOMI             , "HG-SEQ-ME-KINOMI") \
    X(MUS_HG_SEQ_GS_C_ENJU             , "HG-SEQ-GS-C-ENJU") \
    X(MUS_HG_SEQ_GS_KABURENJOU         , "HG-SEQ-GS-KABURENJOU") \
    X(MUS_HG_SEQ_GS_TO_YAKETA          , "HG-SEQ-GS-TO-YAKETA") \
    X(MUS_HG_SEQ_GS_E_MINAKI           , "HG-SEQ-GS-E-MINAKI") \
    X(MUS_HG_SEQ_GS_OHKIDO_RABO        , "HG-SEQ-GS-OHKIDO-RABO") \
    X(MUS_HG_SEQ_ME_HYOUKA4            , "HG-SEQ-ME-HYOUKA4") \
    X(MUS_HG_SEQ_GS_R_6_38             , "HG-SEQ-GS-R-6-38") \
    X(MUS_HG_SEQ_GS_RADIO_MARCH        , "HG-SEQ-GS-RADIO-MARCH") \
    X(MUS_HG_SEQ_GS_VS_RAIKOU          , "HG-SEQ-GS-VS-RAIKOU") \
    X(MUS_HG_SEQ_GS_TO_TOUDAI          , "HG-SEQ-GS-TO-TOUDAI") \
    X(MUS_HG_SEQ_GS_NAMINORI           , "HG-SEQ-GS-NAMINORI") \
    X(MUS_HG_SEQ_GS_C_TANBA            , "HG-SEQ-GS-C-TANBA") \
    X(MUS_HG_SEQ_ME_PT_SPECIAL         , "HG-SEQ-ME-PT-SPECIAL") \
    X(MUS_HG_SEQ_GS_R_7_42             , "HG-SEQ-GS-R-7-42") \
    X(MUS_HG_SEQ_GS_KAIDENPA           , "HG-SEQ-GS-KAIDENPA") \
    X(MUS_HG_SEQ_GS_D_AJITO            , "HG-SEQ-GS-D-AJITO") \
    X(MUS_HG_SEQ_GS_EYE_J_AYASHII      , "HG-SEQ-GS-EYE-J-AYASHII") \
    X(MUS_HG_SEQ_GS_E_RIVAL2           , "HG-SEQ-GS-E-RIVAL2") \
    X(MUS_HG_SEQ_GS_SENKYO             , "HG-SEQ-GS-SENKYO") \
    X(MUS_HG_SEQ_GS_D_KOORINONUKE      , "HG-SEQ-GS-D-KOORINONUKE") \
    X(MUS_HG_SEQ_ME_WASURE             , "HG-SEQ-ME-WASURE") \
    X(MUS_HG_SEQ_GS_RYUUNOANA          , "HG-SEQ-GS-RYUUNOANA") \
    X(MUS_HG_SEQ_GS_IBUKI              , "HG-SEQ-GS-IBUKI") \
    X(MUS_HG_SEQ_GS_VS_ENTEI           , "HG-SEQ-GS-VS-ENTEI") \
    X(MUS_HG_SEQ_GS_TO_SUZU            , "HG-SEQ-GS-TO-SUZU") \
    X(MUS_HG_SEQ_GS_E_MAIKO_MAI        , "HG-SEQ-GS-E-MAIKO-MAI") \
    X(MUS_HG_SEQ_GS_E_HOUOU            , "HG-SEQ-GS-E-HOUOU") \
    X(MUS_HG_SEQ_GS_VS_HOUOU           , "HG-SEQ-GS-VS-HOUOU") \
    X(MUS_HG_SEQ_GS_R_1_26             , "HG-SEQ-GS-R-1-26") \
    X(MUS_HG_SEQ_GS_KOUSOKUSEN         , "HG-SEQ-GS-KOUSOKUSEN") \
    X(MUS_HG_SEQ_GS_C_KUCHIBA          , "HG-SEQ-GS-C-KUCHIBA") \
    X(MUS_HG_SEQ_GS_VS_GYMREADER_KANTO , "HG-SEQ-GS-VS-GYMREADER-KANTO") \
    X(MUS_HG_SEQ_GS_T_CHION            , "HG-SEQ-GS-T-CHION") \
    X(MUS_HG_SEQ_GS_D_IWAYAMA          , "HG-SEQ-GS-D-IWAYAMA") \
    X(MUS_HG_SEQ_GS_VS_NORAPOKE_KANTO  , "HG-SEQ-GS-VS-NORAPOKE-KANTO") \
    X(MUS_HG_SEQ_ME_HYOUKA5            , "HG-SEQ-ME-HYOUKA5") \
    X(MUS_HG_SEQ_GS_C_HANADA           , "HG-SEQ-GS-C-HANADA") \
    X(MUS_HG_SEQ_GS_R_12_24            , "HG-SEQ-GS-R-12-24") \
    X(MUS_HG_SEQ_GS_E_LINEAR           , "HG-SEQ-GS-E-LINEAR") \
    X(MUS_HG_SEQ_GS_RADIO_KOMORIUTA    , "HG-SEQ-GS-RADIO-KOMORIUTA") \
    X(MUS_HG_SEQ_GS_VS_SUICUNE         , "HG-SEQ-GS-VS-SUICUNE") \
    X(MUS_HG_SEQ_GS_C_TAMAMUSHI        , "HG-SEQ-GS-C-TAMAMUSHI") \
    X(MUS_HG_SEQ_GS_R_10_11            , "HG-SEQ-GS-R-10-11") \
    X(MUS_HG_SEQ_GS_HUE                , "HG-SEQ-GS-HUE") \
    X(MUS_HG_SEQ_GS_D_TOKIWANOMORI3    , "HG-SEQ-GS-D-TOKIWANOMORI3") \
    X(MUS_HG_SEQ_GS_EYE_K_SHOUNEN      , "HG-SEQ-GS-EYE-K-SHOUNEN") \
    X(MUS_HG_SEQ_GS_C_YAMABUKI         , "HG-SEQ-GS-C-YAMABUKI") \
    X(MUS_HG_SEQ_GS_R_9_03             , "HG-SEQ-GS-R-9-03") \
    X(MUS_HG_SEQ_GS_EYE_K_AYASHII      , "HG-SEQ-GS-EYE-K-AYASHII") \
    X(MUS_HG_SEQ_GS_OTSUKIMI_EVENT     , "HG-SEQ-GS-OTSUKIMI-EVENT") \
    X(MUS_HG_SEQ_GS_R_9_01             , "HG-SEQ-GS-R-9-01") \
    X(MUS_HG_SEQ_GS_T_MASARA           , "HG-SEQ-GS-T-MASARA") \
    X(MUS_HG_SEQ_GS_OHKIDO             , "HG-SEQ-GS-OHKIDO") \
    X(MUS_HG_SEQ_ME_HYOUKA6            , "HG-SEQ-ME-HYOUKA6") \
    X(MUS_HG_SEQ_GS_EYE_K_SHOUJO       , "HG-SEQ-GS-EYE-K-SHOUJO") \
    X(MUS_HG_SEQ_GS_VS_TRAINER_KANTO   , "HG-SEQ-GS-VS-TRAINER-KANTO") \
    X(MUS_HG_SEQ_GS_T_GUREN            , "HG-SEQ-GS-T-GUREN") \
    X(MUS_HG_SEQ_GS_SAFARI_ROAD        , "HG-SEQ-GS-SAFARI-ROAD") \
    X(MUS_HG_SEQ_GS_SAFARI_HOUSE       , "HG-SEQ-GS-SAFARI-HOUSE") \
    X(MUS_HG_SEQ_GS_SAFARI_FIELD       , "HG-SEQ-GS-SAFARI-FIELD") \
    X(MUS_HG_SEQ_GS_RADIO_VARIETY      , "HG-SEQ-GS-RADIO-VARIETY") \
    X(MUS_HG_SEQ_GS_TAIKAIMAE          , "HG-SEQ-GS-TAIKAIMAE") \
    X(MUS_HG_SEQ_GS_TAIKAI             , "HG-SEQ-GS-TAIKAI") \
    X(MUS_HG_SEQ_ME_MUSHITORI3         , "HG-SEQ-ME-MUSHITORI3") \
    X(MUS_HG_SEQ_ME_MUSHITORI2         , "HG-SEQ-ME-MUSHITORI2") \
    X(MUS_HG_SEQ_ME_MUSHITORI1         , "HG-SEQ-ME-MUSHITORI1") \
    X(MUS_HG_SEQ_GS_PT_ENTR            , "HG-SEQ-GS-PT-ENTR") \
    X(MUS_HG_SEQ_ME_PT_NEW             , "HG-SEQ-ME-PT-NEW") \
    X(MUS_HG_SEQ_GS_PT_OPEN            , "HG-SEQ-GS-PT-OPEN") \
    X(MUS_HG_SEQ_GS_PT_TITLE           , "HG-SEQ-GS-PT-TITLE") \
    X(MUS_HG_SEQ_GS_PT_GAME            , "HG-SEQ-GS-PT-GAME") \
    X(MUS_HG_SEQ_ME_PT_RESULTG         , "HG-SEQ-ME-PT-RESULTG") \
    X(MUS_HG_SEQ_GS_PT_GAMEF           , "HG-SEQ-GS-PT-GAMEF") \
    X(MUS_HG_SEQ_GS_PT_RESULT          , "HG-SEQ-GS-PT-RESULT") \
    X(MUS_HG_SEQ_GS_PT_END             , "HG-SEQ-GS-PT-END") \
    X(MUS_HG_SEQ_GS_PT_VICTORY         , "HG-SEQ-GS-PT-VICTORY") \
    X(MUS_HG_SEQ_GS_WIFI_PRESENT       , "HG-SEQ-GS-WIFI-PRESENT") \
    X(MUS_HG_SEQ_GS_BATTLETOWER2       , "HG-SEQ-GS-BATTLETOWER2") \
    X(MUS_HG_SEQ_GS_BATTLETOWER        , "HG-SEQ-GS-BATTLETOWER") \
    X(MUS_HG_SEQ_ME_BPGET              , "HG-SEQ-ME-BPGET") \
    X(MUS_HG_SEQ_GS_BF_FACTORY         , "HG-SEQ-GS-BF-FACTORY") \
    X(MUS_HG_SEQ_GS_BF_STAGE           , "HG-SEQ-GS-BF-STAGE") \
    X(MUS_HG_SEQ_GS_BF_ROULETTE        , "HG-SEQ-GS-BF-ROULETTE") \
    X(MUS_HG_SEQ_ME_ROULETTE           , "HG-SEQ-ME-ROULETTE") \
    X(MUS_HG_SEQ_GS_BF_CASTLE          , "HG-SEQ-GS-BF-CASTLE") \
    X(MUS_HG_SEQ_ME_CASTLE             , "HG-SEQ-ME-CASTLE") \
    X(MUS_HG_SEQ_GS_BA_BRAIN           , "HG-SEQ-GS-BA-BRAIN") \
    X(MUS_HG_SEQ_GS_WINBRAIN           , "HG-SEQ-GS-WINBRAIN") \
    X(MUS_HG_SEQ_GS_RADIO_TRAINER      , "HG-SEQ-GS-RADIO-TRAINER") \
    X(MUS_HG_SEQ_GS_GURUGURU           , "HG-SEQ-GS-GURUGURU") \
    X(MUS_HG_SEQ_GS_WIFI_ACCESS        , "HG-SEQ-GS-WIFI-ACCESS") \
    X(MUS_HG_SEQ_GS_WIFIUNION          , "HG-SEQ-GS-WIFIUNION") \
    X(MUS_HG_SEQ_GS_WIFIGAME           , "HG-SEQ-GS-WIFIGAME") \
    X(MUS_HG_SEQ_ME_MINIGAME           , "HG-SEQ-ME-MINIGAME") \
    X(MUS_HG_SEQ_GS_WIFIPARADE         , "HG-SEQ-GS-WIFIPARADE") \
    X(MUS_HG_SEQ_GS_RADIO_R_101        , "HG-SEQ-GS-RADIO-R-101") \
    X(MUS_HG_SEQ_GS_RADIO_R_201        , "HG-SEQ-GS-RADIO-R-201") \
    X(MUS_HG_SEQ_GS_PHC                , "HG-SEQ-GS-PHC") \
    X(MUS_HG_SEQ_GS_E_G_PICHU          , "HG-SEQ-GS-E-G-PICHU") \
    X(MUS_HG_SEQ_GS_EYE_MAIKO          , "HG-SEQ-GS-EYE-MAIKO") \
    X(MUS_HG_SEQ_GS_E_LUGIA            , "HG-SEQ-GS-E-LUGIA") \
    X(MUS_HG_SEQ_GS_VS_LUGIA           , "HG-SEQ-GS-VS-LUGIA") \
    X(MUS_HG_SEQ_GS_D_CHAMPROAD        , "HG-SEQ-GS-D-CHAMPROAD") \
    X(MUS_HG_SEQ_GS_CHAMPROAD          , "HG-SEQ-GS-CHAMPROAD") \
    X(MUS_HG_SEQ_GS_VS_CHAMP           , "HG-SEQ-GS-VS-CHAMP") \
    X(MUS_HG_SEQ_GS_E_DENDOURIRI       , "HG-SEQ-GS-E-DENDOURIRI") \
    X(MUS_HG_SEQ_GS_ENDING             , "HG-SEQ-GS-ENDING") \
    X(MUS_HG_SEQ_GS_ENDING2            , "HG-SEQ-GS-ENDING2") \
    X(MUS_HG_SEQ_GS_VS_KODAI           , "HG-SEQ-GS-VS-KODAI") \
    X(MUS_HG_SEQ_GS_D_SHINTO           , "HG-SEQ-GS-D-SHINTO") \
    X(MUS_HG_SEQ_GS_E_ARCEUS           , "HG-SEQ-GS-E-ARCEUS") \
    X(MUS_HG_SEQ_ME_GONIN              , "HG-SEQ-ME-GONIN") \
    X(MUS_BW_SEQ_BGM_GF_LOGO           , "BW-SEQ-BGM-GF-LOGO") \
    X(MUS_BW_SEQ_BGM_TITLE             , "BW-SEQ-BGM-TITLE") \
    X(MUS_BW_SEQ_BGM_TITLE01           , "BW-SEQ-BGM-TITLE01") \
    X(MUS_BW_SEQ_BGM_POKEMON_THEME     , "BW-SEQ-BGM-POKEMON-THEME") \
    X(MUS_BW_SEQ_BGM_STARTING          , "BW-SEQ-BGM-STARTING") \
    X(MUS_BW_SEQ_BGM_STARTING2         , "BW-SEQ-BGM-STARTING2") \
    X(MUS_BW_SEQ_BGM_E_OPENING         , "BW-SEQ-BGM-E-OPENING") \
    X(MUS_BW_SEQ_BGM_T_01              , "BW-SEQ-BGM-T-01") \
    X(MUS_BW_SEQ_BGM_VS_RIVAL          , "BW-SEQ-BGM-VS-RIVAL") \
    X(MUS_BW_SEQ_BGM_E_TSURETEKE1      , "BW-SEQ-BGM-E-TSURETEKE1") \
    X(MUS_BW_SEQ_BGM_E_DOCTOR          , "BW-SEQ-BGM-E-DOCTOR") \
    X(MUS_BW_SEQ_BGM_LABO              , "BW-SEQ-BGM-LABO") \
    X(MUS_BW_SEQ_ME_KEYITEM            , "BW-SEQ-ME-KEYITEM") \
    X(MUS_BW_SEQ_BGM_E_FRIEND          , "BW-SEQ-BGM-E-FRIEND") \
    X(MUS_BW_SEQ_BGM_R_A               , "BW-SEQ-BGM-R-A") \
    X(MUS_BW_SEQ_BGM_VS_NORAPOKE       , "BW-SEQ-BGM-VS-NORAPOKE") \
    X(MUS_BW_SEQ_BGM_WIN1              , "BW-SEQ-BGM-WIN1") \
    X(MUS_BW_SEQ_ME_LVUP               , "BW-SEQ-ME-LVUP") \
    X(MUS_BW_SEQ_BGM_T_02              , "BW-SEQ-BGM-T-02") \
    X(MUS_BW_SEQ_BGM_E_TSURETEKE2      , "BW-SEQ-BGM-E-TSURETEKE2") \
    X(MUS_BW_SEQ_BGM_POKECEN           , "BW-SEQ-BGM-POKECEN") \
    X(MUS_BW_SEQ_ME_ASA                , "BW-SEQ-ME-ASA") \
    X(MUS_BW_SEQ_ME_HYOUKA1            , "BW-SEQ-ME-HYOUKA1") \
    X(MUS_BW_SEQ_BGM_E_SAGE            , "BW-SEQ-BGM-E-SAGE") \
    X(MUS_BW_SEQ_BGM_R_B_SP            , "BW-SEQ-BGM-R-B-SP") \
    X(MUS_BW_SEQ_BGM_R_B_SU            , "BW-SEQ-BGM-R-B-SU") \
    X(MUS_BW_SEQ_BGM_R_B_AU            , "BW-SEQ-BGM-R-B-AU") \
    X(MUS_BW_SEQ_BGM_R_B_WI            , "BW-SEQ-BGM-R-B-WI") \
    X(MUS_BW_SEQ_ME_CALL               , "BW-SEQ-ME-CALL") \
    X(MUS_BW_SEQ_BGM_EYE_01            , "BW-SEQ-BGM-EYE-01") \
    X(MUS_BW_SEQ_BGM_VS_TRAINER        , "BW-SEQ-BGM-VS-TRAINER") \
    X(MUS_BW_SEQ_BGM_WIN2              , "BW-SEQ-BGM-WIN2") \
    X(MUS_BW_SEQ_BGM_EYE_02            , "BW-SEQ-BGM-EYE-02") \
    X(MUS_BW_SEQ_ME_ITEM               , "BW-SEQ-ME-ITEM") \
    X(MUS_BW_SEQ_BGM_C_01              , "BW-SEQ-BGM-C-01") \
    X(MUS_BW_SEQ_ME_HYOUKA2            , "BW-SEQ-ME-HYOUKA2") \
    X(MUS_BW_SEQ_BGM_D_01              , "BW-SEQ-BGM-D-01") \
    X(MUS_BW_SEQ_BGM_D_01_B1F          , "BW-SEQ-BGM-D-01-B1F") \
    X(MUS_BW_SEQ_BGM_E_PLASMA          , "BW-SEQ-BGM-E-PLASMA") \
    X(MUS_BW_SEQ_BGM_VS_PLASMA         , "BW-SEQ-BGM-VS-PLASMA") \
    X(MUS_BW_SEQ_BGM_WIN6              , "BW-SEQ-BGM-WIN6") \
    X(MUS_BW_SEQ_BGM_SHINKA            , "BW-SEQ-BGM-SHINKA") \
    X(MUS_BW_SEQ_BGM_KOUKAN            , "BW-SEQ-BGM-KOUKAN") \
    X(MUS_BW_SEQ_ME_SHINKAOME          , "BW-SEQ-ME-SHINKAOME") \
    X(MUS_BW_SEQ_BGM_EYE_03            , "BW-SEQ-BGM-EYE-03") \
    X(MUS_BW_SEQ_BGM_E_RIVAL           , "BW-SEQ-BGM-E-RIVAL") \
    X(MUS_BW_SEQ_BGM_E_TROUBLE         , "BW-SEQ-BGM-E-TROUBLE") \
    X(MUS_BW_SEQ_BGM_C_02              , "BW-SEQ-BGM-C-02") \
    X(MUS_BW_SEQ_ME_HYOUKA3            , "BW-SEQ-ME-HYOUKA3") \
    X(MUS_BW_SEQ_BGM_GYM               , "BW-SEQ-BGM-GYM") \
    X(MUS_BW_SEQ_BGM_VS_GYMLEADER      , "BW-SEQ-BGM-VS-GYMLEADER") \
    X(MUS_BW_SEQ_BGM_BATTLESUPERIOR    , "BW-SEQ-BGM-BATTLESUPERIOR") \
    X(MUS_BW_SEQ_BGM_WIN3              , "BW-SEQ-BGM-WIN3") \
    X(MUS_BW_SEQ_ME_BADGE              , "BW-SEQ-ME-BADGE") \
    X(MUS_BW_SEQ_ME_WAZA               , "BW-SEQ-ME-WAZA") \
    X(MUS_BW_SEQ_BGM_GATE              , "BW-SEQ-BGM-GATE") \
    X(MUS_BW_SEQ_BGM_H_01              , "BW-SEQ-BGM-H-01") \
    X(MUS_BW_SEQ_BGM_C_03              , "BW-SEQ-BGM-C-03") \
    X(MUS_BW_SEQ_BGM_EYE_12            , "BW-SEQ-BGM-EYE-12") \
    X(MUS_BW_SEQ_BGM_R_C_SP            , "BW-SEQ-BGM-R-C-SP") \
    X(MUS_BW_SEQ_BGM_R_C_SU            , "BW-SEQ-BGM-R-C-SU") \
    X(MUS_BW_SEQ_BGM_R_C_AU            , "BW-SEQ-BGM-R-C-AU") \
    X(MUS_BW_SEQ_BGM_R_C_WI            , "BW-SEQ-BGM-R-C-WI") \
    X(MUS_BW_SEQ_BGM_EYE_11            , "BW-SEQ-BGM-EYE-11") \
    X(MUS_BW_SEQ_BGM_C_04              , "BW-SEQ-BGM-C-04") \
    X(MUS_BW_SEQ_BGM_E_SUPPORT         , "BW-SEQ-BGM-E-SUPPORT") \
    X(MUS_BW_SEQ_BGM_E_EMOTION         , "BW-SEQ-BGM-E-EMOTION") \
    X(MUS_BW_SEQ_BGM_E_N               , "BW-SEQ-BGM-E-N") \
    X(MUS_BW_SEQ_BGM_VS_N              , "BW-SEQ-BGM-VS-N") \
    X(MUS_BW_SEQ_BGM_BATTLEPINCH       , "BW-SEQ-BGM-BATTLEPINCH") \
    X(MUS_BW_SEQ_BGM_BICYCLE           , "BW-SEQ-BGM-BICYCLE") \
    X(MUS_BW_SEQ_BGM_E_CHAMPION        , "BW-SEQ-BGM-E-CHAMPION") \
    X(MUS_BW_SEQ_BGM_H_02              , "BW-SEQ-BGM-H-02") \
    X(MUS_BW_SEQ_BGM_C_05              , "BW-SEQ-BGM-C-05") \
    X(MUS_BW_SEQ_BGM_D_03              , "BW-SEQ-BGM-D-03") \
    X(MUS_BW_SEQ_BGM_R_D_SP            , "BW-SEQ-BGM-R-D-SP") \
    X(MUS_BW_SEQ_BGM_R_D_SU            , "BW-SEQ-BGM-R-D-SU") \
    X(MUS_BW_SEQ_BGM_R_D_AU            , "BW-SEQ-BGM-R-D-AU") \
    X(MUS_BW_SEQ_BGM_R_D_WI            , "BW-SEQ-BGM-R-D-WI") \
    X(MUS_BW_SEQ_BGM_EYE_06            , "BW-SEQ-BGM-EYE-06") \
    X(MUS_BW_SEQ_BGM_EYE_09            , "BW-SEQ-BGM-EYE-09") \
    X(MUS_BW_SEQ_BGM_D_02              , "BW-SEQ-BGM-D-02") \
    X(MUS_BW_SEQ_BGM_D_02_B1F          , "BW-SEQ-BGM-D-02-B1F") \
    X(MUS_BW_SEQ_BGM_D_02_B2F          , "BW-SEQ-BGM-D-02-B2F") \
    X(MUS_BW_SEQ_BGM_C_06              , "BW-SEQ-BGM-C-06") \
    X(MUS_BW_SEQ_BGM_E_DOCTOR2         , "BW-SEQ-BGM-E-DOCTOR2") \
    X(MUS_BW_SEQ_ME_HYOUKA4            , "BW-SEQ-ME-HYOUKA4") \
    X(MUS_BW_SEQ_ME_WASURE             , "BW-SEQ-ME-WASURE") \
    X(MUS_BW_SEQ_BGM_EYE_08            , "BW-SEQ-BGM-EYE-08") \
    X(MUS_BW_SEQ_BGM_C_07              , "BW-SEQ-BGM-C-07") \
    X(MUS_BW_SEQ_BGM_D_05              , "BW-SEQ-BGM-D-05") \
    X(MUS_BW_SEQ_BGM_EYE_PLASMA        , "BW-SEQ-BGM-EYE-PLASMA") \
    X(MUS_BW_SEQ_BGM_D_07              , "BW-SEQ-BGM-D-07") \
    X(MUS_BW_SEQ_BGM_D_04              , "BW-SEQ-BGM-D-04") \
    X(MUS_BW_SEQ_ME_ITEM_MYSTERY       , "BW-SEQ-ME-ITEM-MYSTERY") \
    X(MUS_BW_SEQ_BGM_H_03              , "BW-SEQ-BGM-H-03") \
    X(MUS_BW_SEQ_BGM_FS                , "BW-SEQ-BGM-FS") \
    X(MUS_BW_SEQ_BGM_EYE_05            , "BW-SEQ-BGM-EYE-05") \
    X(MUS_BW_SEQ_BGM_C_08_B            , "BW-SEQ-BGM-C-08-B") \
    X(MUS_BW_SEQ_BGM_C_08_W            , "BW-SEQ-BGM-C-08-W") \
    X(MUS_BW_SEQ_BGM_R_F               , "BW-SEQ-BGM-R-F") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD       , "BW-SEQ-BGM-D-CHAMPROAD") \
    X(MUS_BW_SEQ_BGM_EYE_04            , "BW-SEQ-BGM-EYE-04") \
    X(MUS_BW_SEQ_BGM_POKEMON_LEAGUE    , "BW-SEQ-BGM-POKEMON-LEAGUE") \
    X(MUS_BW_SEQ_BGM_VS_SHITENNO       , "BW-SEQ-BGM-VS-SHITENNO") \
    X(MUS_BW_SEQ_BGM_E_N_CASTLE        , "BW-SEQ-BGM-E-N-CASTLE") \
    X(MUS_BW_SEQ_BGM_N_CASTLE_BRIDGE   , "BW-SEQ-BGM-N-CASTLE-BRIDGE") \
    X(MUS_BW_SEQ_BGM_N_CASTLE          , "BW-SEQ-BGM-N-CASTLE") \
    X(MUS_BW_SEQ_BGM_N_ROOM            , "BW-SEQ-BGM-N-ROOM") \
    X(MUS_BW_SEQ_BGM_E_LEGEND_COME     , "BW-SEQ-BGM-E-LEGEND-COME") \
    X(MUS_BW_SEQ_BGM_E_LEGEND_BORN     , "BW-SEQ-BGM-E-LEGEND-BORN") \
    X(MUS_BW_SEQ_BGM_VS_SHIN           , "BW-SEQ-BGM-VS-SHIN") \
    X(MUS_BW_SEQ_BGM_VS_N_2            , "BW-SEQ-BGM-VS-N-2") \
    X(MUS_BW_SEQ_BGM_E_G_CIS           , "BW-SEQ-BGM-E-G-CIS") \
    X(MUS_BW_SEQ_BGM_VS_G_CIS          , "BW-SEQ-BGM-VS-G-CIS") \
    X(MUS_BW_SEQ_BGM_E_LAST            , "BW-SEQ-BGM-E-LAST") \
    X(MUS_BW_SEQ_BGM_ENDING            , "BW-SEQ-BGM-ENDING") \
    X(MUS_BW_SEQ_BGM_E_HANDSOME        , "BW-SEQ-BGM-E-HANDSOME") \
    X(MUS_BW_SEQ_ME_TAMAGO_GET         , "BW-SEQ-ME-TAMAGO-GET") \
    X(MUS_BW_SEQ_BGM_PLEASURE_BOAT     , "BW-SEQ-BGM-PLEASURE-BOAT") \
    X(MUS_BW_SEQ_BGM_WIFI_ACCESS       , "BW-SEQ-BGM-WIFI-ACCESS") \
    X(MUS_BW_SEQ_BGM_GLTERMINAL        , "BW-SEQ-BGM-GLTERMINAL") \
    X(MUS_BW_SEQ_BGM_GTS               , "BW-SEQ-BGM-GTS") \
    X(MUS_BW_SEQ_BGM_GURUGURU          , "BW-SEQ-BGM-GURUGURU") \
    X(MUS_BW_SEQ_BGM_UNITED_NATIONS    , "BW-SEQ-BGM-UNITED-NATIONS") \
    X(MUS_BW_SEQ_ME_HYOUKA5            , "BW-SEQ-ME-HYOUKA5") \
    X(MUS_BW_SEQ_BGM_GEAR_STATION      , "BW-SEQ-BGM-GEAR-STATION") \
    X(MUS_BW_SEQ_BGM_BATTLE_SUBWAY     , "BW-SEQ-BGM-BATTLE-SUBWAY") \
    X(MUS_BW_SEQ_BGM_VS_SUBWAY_TRAINER , "BW-SEQ-BGM-VS-SUBWAY-TRAINER") \
    X(MUS_BW_SEQ_ME_BPGET              , "BW-SEQ-ME-BPGET") \
    X(MUS_BW_SEQ_BGM_MSL_FIELD         , "BW-SEQ-BGM-MSL-FIELD") \
    X(MUS_BW_SEQ_ME_ACCE               , "BW-SEQ-ME-ACCE") \
    X(MUS_BW_SEQ_BGM_MSL_DRESSUP       , "BW-SEQ-BGM-MSL-DRESSUP") \
    X(MUS_BW_SEQ_BGM_MSL_BEFORE        , "BW-SEQ-BGM-MSL-BEFORE") \
    X(MUS_BW_SEQ_BGM_MSL_01            , "BW-SEQ-BGM-MSL-01") \
    X(MUS_BW_SEQ_BGM_MSL_02            , "BW-SEQ-BGM-MSL-02") \
    X(MUS_BW_SEQ_BGM_MSL_03            , "BW-SEQ-BGM-MSL-03") \
    X(MUS_BW_SEQ_BGM_MSL_04            , "BW-SEQ-BGM-MSL-04") \
    X(MUS_BW_SEQ_BGM_MSL_DL_MUNNA      , "BW-SEQ-BGM-MSL-DL-MUNNA") \
    X(MUS_BW_SEQ_BGM_MSL_DL_SMASH      , "BW-SEQ-BGM-MSL-DL-SMASH") \
    X(MUS_BW_SEQ_BGM_MSL_DL_FESTA      , "BW-SEQ-BGM-MSL-DL-FESTA") \
    X(MUS_BW_SEQ_BGM_MSL_DL_RELIC      , "BW-SEQ-BGM-MSL-DL-RELIC") \
    X(MUS_BW_SEQ_BGM_MSL_DL_RUNPA      , "BW-SEQ-BGM-MSL-DL-RUNPA") \
    X(MUS_BW_SEQ_BGM_E_KANRANSYA       , "BW-SEQ-BGM-E-KANRANSYA") \
    X(MUS_BW_SEQ_ME_AISHOU_KIDOU       , "BW-SEQ-ME-AISHOU-KIDOU") \
    X(MUS_BW_SEQ_ME_AISHOU_H           , "BW-SEQ-ME-AISHOU-H") \
    X(MUS_BW_SEQ_ME_AISHOU_M           , "BW-SEQ-ME-AISHOU-M") \
    X(MUS_BW_SEQ_ME_AISHOU_L           , "BW-SEQ-ME-AISHOU-L") \
    X(MUS_BW_SEQ_BGM_VS_MOVEPOKE       , "BW-SEQ-BGM-VS-MOVEPOKE") \
    X(MUS_BW_SEQ_BGM_T_03              , "BW-SEQ-BGM-T-03") \
    X(MUS_BW_SEQ_BGM_H_05              , "BW-SEQ-BGM-H-05") \
    X(MUS_BW_SEQ_BGM_R_E_SP            , "BW-SEQ-BGM-R-E-SP") \
    X(MUS_BW_SEQ_BGM_R_E_SU            , "BW-SEQ-BGM-R-E-SU") \
    X(MUS_BW_SEQ_BGM_R_E_AU            , "BW-SEQ-BGM-R-E-AU") \
    X(MUS_BW_SEQ_BGM_R_E_WI            , "BW-SEQ-BGM-R-E-WI") \
    X(MUS_BW_SEQ_BGM_EYE_07            , "BW-SEQ-BGM-EYE-07") \
    X(MUS_BW_SEQ_BGM_PALPARK           , "BW-SEQ-BGM-PALPARK") \
    X(MUS_BW_SEQ_BGM_PALPARK_BOX       , "BW-SEQ-BGM-PALPARK-BOX") \
    X(MUS_BW_SEQ_BGM_PALPARK_GAME      , "BW-SEQ-BGM-PALPARK-GAME") \
    X(MUS_BW_SEQ_BGM_EYE_10            , "BW-SEQ-BGM-EYE-10") \
    X(MUS_BW_SEQ_BGM_C_10_B            , "BW-SEQ-BGM-C-10-B") \
    X(MUS_BW_SEQ_BGM_C_10_W            , "BW-SEQ-BGM-C-10-W") \
    X(MUS_BW_SEQ_BGM_GAME_SYNC         , "BW-SEQ-BGM-GAME-SYNC") \
    X(MUS_BW_SEQ_BGM_PALACE            , "BW-SEQ-BGM-PALACE") \
    X(MUS_BW_SEQ_ME_MISSION_START      , "BW-SEQ-ME-MISSION-START") \
    X(MUS_BW_SEQ_BGM_PALACE2           , "BW-SEQ-BGM-PALACE2") \
    X(MUS_BW_SEQ_ME_MISSION_CLEAR      , "BW-SEQ-ME-MISSION-CLEAR") \
    X(MUS_BW_SEQ_ME_MISSION_FAILED     , "BW-SEQ-ME-MISSION-FAILED") \
    X(MUS_BW_SEQ_BGM_EYE_13            , "BW-SEQ-BGM-EYE-13") \
    X(MUS_BW_SEQ_BGM_T_05_SP           , "BW-SEQ-BGM-T-05-SP") \
    X(MUS_BW_SEQ_BGM_T_05_SU           , "BW-SEQ-BGM-T-05-SU") \
    X(MUS_BW_SEQ_BGM_E_SHIRONA         , "BW-SEQ-BGM-E-SHIRONA") \
    X(MUS_BW_SEQ_BGM_VS_SHIRONA        , "BW-SEQ-BGM-VS-SHIRONA") \
    X(MUS_BW_SEQ_BGM_D_06              , "BW-SEQ-BGM-D-06") \
    X(MUS_BW_SEQ_BGM_VS_TSUYOPOKE      , "BW-SEQ-BGM-VS-TSUYOPOKE") \
    X(MUS_BW_SEQ_BGM_NAMINORI          , "BW-SEQ-BGM-NAMINORI") \
    X(MUS_BW_SEQ_BGM_DIVING            , "BW-SEQ-BGM-DIVING") \
    X(MUS_BW_SEQ_BGM_T_04              , "BW-SEQ-BGM-T-04") \
    X(MUS_BW_SEQ_BGM_H_04              , "BW-SEQ-BGM-H-04") \
    X(MUS_BW_SEQ_BGM_WIFI_PRESENT      , "BW-SEQ-BGM-WIFI-PRESENT") \
    X(MUS_BW_SEQ_BGM_WCS               , "BW-SEQ-BGM-WCS") \
    X(MUS_BW_SEQ_BGM_E_SOUND_DESIGNER  , "BW-SEQ-BGM-E-SOUND-DESIGNER") \
    X(MUS_BW_SEQ_BGM_VS_RAI            , "BW-SEQ-BGM-VS-RAI") \
    X(MUS_BW_SEQ_ME_HYOUKA6            , "BW-SEQ-ME-HYOUKA6") \
    X(MUS_BW_SEQ_BGM_VS_CHAMP          , "BW-SEQ-BGM-VS-CHAMP") \
    X(MUS_BW_SEQ_BGM_WIN5              , "BW-SEQ-BGM-WIN5") \
    X(MUS_BW_SEQ_BGM_E_DENDOUIRI       , "BW-SEQ-BGM-E-DENDOUIRI") \
    X(MUS_BW_SEQ_BGM_E_INISHIE         , "BW-SEQ-BGM-E-INISHIE") \
    X(MUS_BW_SEQ_BGM_VS_WCS            , "BW-SEQ-BGM-VS-WCS") \
    X(MUS_BW_SEQ_ME_KINOMI             , "BW-SEQ-ME-KINOMI") \
