const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 28, SPECIES_GOLDUCK}},
    ...
    [SPECIES_MACHOKE]               = {{EVO_LEVEL, 39, SPECIES_MACHAMP}},
    ...
    [SPECIES_ONIX]                  = {{EVO_ITEM_HOLD, ITEM_LAGGING_TAIL, SPECIES_STEELIX}},
    ...
    [SPECIES_KOFFING]	            = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_MOVE, MOVE_HAZE, SPECIES_WEEZING_GALARIAN}},
    [SPECIES_RHYHORN]	            = {{EVO_LEVEL, 32, SPECIES_RHYDON}},
    [SPECIES_RHYDON]	            = {{EVO_ITEM_HOLD, ITEM_PROTECTOR, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]	            = {{EVO_ITEM_HOLD, ITEM_LUCKY_PUNCH, SPECIES_BLISSEY}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_ITEM_HOLD, ITEM_IRON_BALL, SPECIES_SCIZOR},
                                       {EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_KLEAVOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM_HOLD, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]	            = {{EVO_ITEM_HOLD, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}},
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM_HOLD, ITEM_ELECTRIC_GEM, SPECIES_JOLTEON},
                                       {EVO_ITEM_HOLD, ITEM_WATER_GEM, SPECIES_VAPOREON},
                                       {EVO_ITEM_HOLD, ITEM_FIRE_GEM, SPECIES_FLAREON},
                                       {EVO_ITEM_HOLD, ITEM_PSYCHIC_GEM, SPECIES_ESPEON},
                                       {EVO_ITEM_HOLD, ITEM_DARK_GEM, SPECIES_UMBREON},
                                       {EVO_ITEM_HOLD, ITEM_GRASS_GEM, SPECIES_LEAFEON},
                                       {EVO_ITEM_HOLD, ITEM_ICE_GEM, SPECIES_GLACEON},
                                       {EVO_ITEM_HOLD, ITEM_FAIRY_GEM, SPECIES_SYLVEON}},
    [SPECIES_PORYGON]	            = {{EVO_ITEM_HOLD, ITEM_UPGRADE, SPECIES_PORYGON2}},
    ...
    [SPECIES_CYNDAQUIL]	            = {{EVO_LEVEL, 17, SPECIES_QUILAVA}},
    [SPECIES_QUILAVA]	            = {{EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                       {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_TYPHLOSION_HISUIAN}},
    ...
    [SPECIES_TOGEPI]	            = {{EVO_LEVEL, 30, SPECIES_TOGETIC}},
    ...
    [SPECIES_URSARING]	            = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSALUNA}},
    ...
    [SPECIES_PORYGON2]	            = {{EVO_ITEM_HOLD, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z}},
    [SPECIES_STANTLER]	            = {{EVO_LEVEL, 32, SPECIES_WYRDEER}},
    ...
    [SPECIES_NOSEPASS]	            = {{EVO_ITEM_HOLD, ITEM_FLOAT_STONE, SPECIES_PROBOPASS}},
    ...
    [SPECIES_FEEBAS]	            = {{EVO_ITEM_HOLD, ITEM_PRISM_SCALE, SPECIES_MILOTIC}},
    ...
    [SPECIES_DUSCLOPS]	            = {{EVO_ITEM_HOLD, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR}},
	...
	[SPECIES_COMBEE]	            = {{EVO_LEVEL_FEMALE, 23, SPECIES_VESPIQUEN}},
	...
	[SPECIES_BUNEARY]	            = {{EVO_LEVEL, 18, SPECIES_LOPUNNY}},
	[SPECIES_LOPUNNY]	            = {{EVO_MEGA_EVOLUTION, ITEM_LOPUNNITE, SPECIES_LOPUNNY_MEGA}},
	[SPECIES_GLAMEOW]	            = {{EVO_LEVEL, 28, SPECIES_PURUGLY}},
	[SPECIES_CHINGLING]	            = {{EVO_LEVEL, 20, SPECIES_CHIMECHO}},
	[SPECIES_STUNKY]	            = {{EVO_LEVEL, 28, SPECIES_SKUNTANK}},
	...
	[SPECIES_MUNCHLAX]	            = {{EVO_LEVEL, 40, SPECIES_SNORLAX}},
	[SPECIES_RIOLU]	                = {{EVO_LEVEL, 40, SPECIES_LUCARIO}},
	...
	[SPECIES_WOOBAT]	            = {{EVO_LEVEL, 19, SPECIES_SWOOBAT}},
	...
	[SPECIES_GURDURR]	            = {{EVO_LEVEL, 36, SPECIES_CONKELDURR}},
	...
	[SPECIES_SWADLOON]	            = {{EVO_LEVEL, 28, SPECIES_LEAVANNY}},
	...
	[SPECIES_GOTHITA]	            = {{EVO_LEVEL, 27, SPECIES_GOTHORITA}},
	[SPECIES_GOTHORITA]	            = {{EVO_LEVEL, 41, SPECIES_GOTHITELLE}},
	[SPECIES_SOLOSIS]	            = {{EVO_LEVEL, 27, SPECIES_DUOSION}},
	...
	[SPECIES_VANILLISH]	            = {{EVO_LEVEL, 35, SPECIES_VANILLUXE}},
	[SPECIES_DEERLING]	            = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK}},
	[SPECIES_KARRABLAST]            = {{EVO_LEVEL, 37, SPECIES_ESCAVALIER}},
	...
	[SPECIES_SHELMET]	            = {{EVO_LEVEL, 37, SPECIES_ACCELGOR}},
	[SPECIES_MIENFOO]	            = {{EVO_LEVEL, 40, SPECIES_MIENSHAO}},
	[SPECIES_GOLETT]	            = {{EVO_LEVEL, 38, SPECIES_GOLURK}},
	...
	[SPECIES_PANCHAM]	            = {{EVO_LEVEL, 27, SPECIES_PANGORO}},
	...
	[SPECIES_SPRITZEE]	            = {{EVO_ITEM_HOLD, ITEM_SACHET, SPECIES_AROMATISSE}},
	[SPECIES_SWIRLIX]	            = {{EVO_ITEM_HOLD, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF}},
	[SPECIES_INKAY]	                = {{EVO_LEVEL, 30, SPECIES_MALAMAR}},
	[SPECIES_BINACLE]	            = {{EVO_LEVEL, 39, SPECIES_BARBARACLE}},
	[SPECIES_SKRELP]	            = {{EVO_LEVEL, 38, SPECIES_DRAGALGE}},
	...
	[SPECIES_PHANTUMP]	            = {{EVO_LEVEL, 22, SPECIES_TREVENANT}},
	[SPECIES_PUMPKABOO]	            = {{EVO_LEVEL, 22, SPECIES_GOURGEIST}},
	[SPECIES_BERGMITE]	            = {{EVO_LEVEL, 37, SPECIES_AVALUGG}},
                                    //    {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_AVALUGG_HISUIAN}},
	[SPECIES_NOIBAT]	            = {{EVO_LEVEL, 38, SPECIES_NOIVERN}},
	...
	[SPECIES_DARTRIX]	            = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_ITEM_HOLD, ITEM_RING_TARGET, SPECIES_DECIDUEYE_HISUIAN}},
	...
	[SPECIES_ROCKRUFF]	            = {{EVO_LEVEL_NATURE_MIDDAY, 25, SPECIES_LYCANROC},
                                       {EVO_LEVEL_NATURE_MIDNIGHT, 25, SPECIES_LYCANROC_MIDNIGHT},
                                       {EVO_LEVEL_NATURE_DUSK, 25, SPECIES_LYCANROC_DUSK}},
	...
	[SPECIES_FOMANTIS]	            = {{EVO_LEVEL, 24, SPECIES_LURANTIS}},
	...
	[SPECIES_SANDYGAST]	            = {{EVO_LEVEL, 37, SPECIES_PALOSSAND}},
    ...
    [SPECIES_SILICOBRA]             = {{EVO_LEVEL, 26, SPECIES_SANDACONDA}},
    ...
    [SPECIES_CLOBBOPUS]             = {{EVO_LEVEL, 30, SPECIES_GRAPPLOCT}},
    [SPECIES_SINISTEA]              = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_POLTEAGEIST}},
    [SPECIES_HATENNA]               = {{EVO_LEVEL, 22, SPECIES_HATTREM}},
    [SPECIES_HATTREM]               = {{EVO_LEVEL, 42, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 22, SPECIES_MORGREM}},
    [SPECIES_MORGREM]               = {{EVO_LEVEL, 42, SPECIES_GRIMMSNARL}},
    [SPECIES_MILCERY]               = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ALCREMIE_RUBY_SWIRL}/*{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ALCREMIE},
                                       {EVO_LEVEL, ITEM_, SPECIES_ALCREMIE_RUBY_CREAM},
    ...
    [SPECIES_DREEPY]                = {{EVO_LEVEL, 40, SPECIES_DRAKLOAK}},
    ...
    [SPECIES_GRAVELER_ALOLAN]	    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_GRIMER_ALOLAN]	        = {{EVO_LEVEL, 38, SPECIES_MUK_ALOLAN}},
    [SPECIES_MEOWTH_GALARIAN]       = {{EVO_LEVEL, 28, SPECIES_PERRSERKER}},
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_LEVEL, 30, SPECIES_RAPIDASH_GALARIAN}},
    ...
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_LEVEL, 35, SPECIES_SIRFETCHD},
                                       {EVO_CRITICAL_HITS, 3, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_QWILFISH_HISUIAN]      = {{EVO_LEVEL, 35, SPECIES_OVERQWIL}},
    [SPECIES_SNEASEL_HISUIAN]       = {{EVO_ITEM_HOLD, ITEM_GRIP_CLAW, SPECIES_SNEASLER}},
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_BASCULEGION}},
