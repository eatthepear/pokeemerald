...
const u32 gTMHMLearnsets[][2] =
{
    ...
    [SPECIES_REGIDRAGO]   = TMHM_LEARNSET(TMHM(TMHM(TM27_RETURN) //dragon claw
                                            | TMHM(TM42_FACADE)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM16_LIGHT_SCREEN)
                                            | TMHM(TM01_PROTECT)
    ...
    [SPECIES_SPECTRIER]   = TMHM_LEARNSET(TMHM(TM09_CALM_MIND)
                                            | TMHM(TM42_FACADE)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM01_PROTECT)
                                            | TMHM(TM07_REST)
    ...
    [SPECIES_CALYREX]     = TMHM_LEARNSET(TMHM(TMHM(TM09_CALM_MIND)
                                            | TMHM(TM42_FACADE)
                                            | TMHM(TM19_GIGA_DRAIN)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM16_LIGHT_SCREEN)
    ...
    [SPECIES_ARTICUNO_GALARIAN]= TMHM_LEARNSET(TMHM(TM09_CALM_MIND)
                                            | TMHM(TM42_FACADE)
                                            | TMHM(HM02_FLY)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM16_LIGHT_SCREEN)
    ...
    [SPECIES_CALYREX_SHADOW_RIDER]= TMHM_LEARNSET(TMHM(TM09_CALM_MIND)
                                            | TMHM(TM42_FACADE)
                                            | TMHM(TM19_GIGA_DRAIN)
                                            | TMHM(TM15_HYPER_BEAM)
                                            | TMHM(TM16_LIGHT_SCREEN)
