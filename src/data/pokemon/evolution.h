const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_FINNEON]               = {{EVO_LEVEL, 18, SPECIES_LUMINEON}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG},
                                       {EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_AVALUGG_HISUIAN}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_DECIDUEYE_HISUIAN}},
    ...
    [SPECIES_ROCKRUFF]              = {{EVO_LEVEL_MIDDAY, 25, SPECIES_LYCANROC},
                                       {EVO_LEVEL_MIDNIGHT, 25, SPECIES_LYCANROC_MIDNIGHT},
