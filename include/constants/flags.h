...
#define FLAG_HIDE_ZONE12A_MAN    0x41 // Unused Flag
...
#define FLAG_HIDDEN_ITEM_ZONE8A_RED_SHARD                    (FLAG_HIDDEN_ITEMS_START + 0x1A)
...
#define FLAG_HIDDEN_ITEM_ZONE20A_RED_SHARD                   (FLAG_HIDDEN_ITEMS_START + 0x6A)
