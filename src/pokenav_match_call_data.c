...
static const match_call_text_data_t sNormanTextScripts[] = {
    { MatchCall_Text_Norman1, 0xFFFE, 0xFFFF },
    { MatchCall_Text_Norman2, 0xFFFE,     0xFFFF },
    { MatchCall_Text_Norman3, 0xFFFE,   0xFFFF },
    { MatchCall_Text_Norman4, 0xFFFE,   0xFFFF },
    { MatchCall_Text_Norman5, 0xFFFE, 0xFFFF },
    { MatchCall_Text_Norman6, 0xFFFE,                        0xFFFF },
    { MatchCall_Text_Norman7, 0xFFFE,           0xFFFF },
    { MatchCall_Text_Norman8, 0xFFFE,           0xFFFF },
    { MatchCall_Text_Norman9, 0xFFFE,           0xFFFF },
    { NULL,                   0xFFFF,                        0xFFFF }
};
...
static const match_call_text_data_t sMomTextScripts[] = {
    ...
    { MatchCall_Text_Mom2, 0xFFFF, 0xFFFF },
...
static const match_call_text_data_t sStevenTextScripts[] = {
    ...
    { MatchCall_Text_Steven5, 0xFFFF,          0xFFFF },
    { MatchCall_Text_Steven6, FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
    { MatchCall_Text_Steven7, 0xFFFF,                 0xFFFF },
    { NULL,                   0xFFFF,                              0xFFFF },
};
...
static const match_call_text_data_t sWallyTextScripts[] = {
    ...
    { MatchCall_Text_Wally3, 0xFFFF,         0xFFFF },
    { MatchCall_Text_Wally4, 0xFFFF,              0xFFFF },
...
static const match_call_text_data_t sScottTextScripts[] = {
    ...
    { MatchCall_Text_Scott6, 0xFFFF,        0xFFFF },
    { MatchCall_Text_Scott7, 0xFFFF,                 0xFFFF },
    { NULL,                  0xFFFF,                              0xFFFF }
};
