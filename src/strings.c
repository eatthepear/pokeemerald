...
const u8 gText_DefaultNameStu[] = _("Testing");
...
const u8 gText_DefaultNameKimmy[] = _("Testing");
...
const u8 gText_ThisIsAPokemon[] = _("Using Porygon's limitless potential,{PAUSE 96}\p");
...
const u8 gText_DexHoennTitle[] = _("PBL Dex");
...
const u8 gText_DexHoennDescription[] = _("Pokémon Battle Labyrinth Pokédex");
...
const u8 gText_BirchInTrouble[] = _("Choose a starter Pokémon!");
...
const u8 gText_DadsAdvice[] = _("You can't use that right now...\nThere's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlaceholderMint[] = _("This item hasn't been implemented\nyet. Wait until the next update!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInSuperPotion[] = _("I'll throw in a Super Potion, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_XNatureBoughtFarm[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nbought from a Cowgirl\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureAdopted[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nadopted from a Breeder\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureRevived[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nrevived from a fossil\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureBoughtRuin[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nbought from a Ruin Maniac\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_HPUp1000[] = _("HP Uo{CLEAR_TO 99}{FONT_SMALL}1,000");
const u8 gText_PPUp3000[] = _("PP Uo{CLEAR_TO 99}{FONT_SMALL}3,000");
...
const u8 gText_TrainerCardPokedex[] = _("Difficulty");
const u8 gText_TrainerCardZonesCompleted[] = _("Zones Completed");
const u8 gText_TrainerCardLevelCap[] = _("Level Cap");
const u8 gText_TrainerCardOpponentsRemaining[] = _("Foes Remaining");
const u8 gText_TrainerCardItemsRemaining[] = _("Items Remaining");
...
const u8 gText_TrainerCardMode[] = _("Mode");
const u8 gText_TrainerCardDefault[] =_("Default");
const u8 gText_TrainerCardBrutal[] =_("Brutal");
const u8 gText_TrainerCardInfinite[] =_("Infinite");
const u8 gText_TrainerCardVanilla[] =_("Vanilla");
const u8 gText_TrainerCardRandomizer[] =_("Randomizer");
const u8 gText_TrainerCardNuzlocke[] =_("Nuzlocke");
const u8 gText_TrainerCardRandomlocke[] =_("Randomlocke");
...
const u8 gText_OptionMenuCancel[] = _("Save Options");
...
const u8 gText_MenuReturn[] = _("Return");
...
const u8 gText_RSE[] = _("RSE");
const u8 gText_FRLG[] = _("FRLG");
const u8 gText_DPPt[] = _("DPPt");
const u8 gText_HGSSJohto[] = _("HGSS (Johto)");
const u8 gText_HGSSKanto[] = _("HGSS (Kanto)");
const u8 gText_BW[] = _("BW");
const u8 gText_Default[] = _("{COLOR BLUE}Default");
const u8 gText_Brutal[] = _("{COLOR RED}Brutal");
const u8 gText_Infinite[] = _("{COLOR GREEN}Infinite");
const u8 gText_ContinueMenuZone[] = _("Zones Completed");
const u8 gText_ContinueMenuRandomizer[] =_("Randomizer");
const u8 gText_ContinueMenuNuzlocke[] =_("Nuzlocke");
const u8 gText_ContinueMenuRandomlocke[] =_("Randomlocke");
const u8 gText_ContinueMenuBrutal[] =_("Brutal");
const u8 gText_ContinueMenuBrutalRandomizer[] =_("Brutal Randomizer");
const u8 gText_ContinueMenuBrutalNuzlocke[] =_("Brutal Nuzlocke");
const u8 gText_ContinueMenuBrutalRandomlocke[] =_("Brutal Randomlocke");
const u8 gText_ContinueMenuInfinite[] =_("Infinite");
const u8 gText_ContinueMenuInfiniteRandomizer[] =_("Infinite Randomizer");
const u8 gText_ContinueMenuInfiniteNuzlocke[] =_("Infinite Nuzlocke");
const u8 gText_ContinueMenuInfiniteRandomlocke[] =_("Infinite Randomlocke");
const u8 gText_SaveMenuVanilla[] =_("Vanilla");
...
const u8 gText_SaveMenuDefault[] =_("Default");
...
const u8 gText_SavingPokedex[] = _("Difficulty");
const u8 gText_SavingTime[] = _("Mode");
...
const u8 gText_Lelouch_HP[] = _("HP");
const u8 gText_Lelouch_Attack[] = _("Attack");
const u8 gText_Lelouch_Defense[] = _("Defense");
const u8 gText_Lelouch_SpAtk[] = _("Sp. Atk");
const u8 gText_Lelouch_SpDef[] = _("Sp. Def");
const u8 gText_Lelouch_Speed[] = _("Speed");
const u8 gText_Lelouch_252[] = _("252");
const u8 gText_Lelouch_200[] = _("200");
const u8 gText_Lelouch_100[] = _("100");
const u8 gText_Lelouch_4[] = _("4");
const u8 gText_Lelouch_0[] = _("0");
const u8 gText_Lelouch_31[] = _("31");
const u8 gText_Lelouch_30[] = _("30");
const u8 gText_Lelouch_1[] = _("1");
...
const u8 gText_SpDefenseMints[] =_("Sp. Defense Mint");
const u8 gText_SpeedMints[] =_("Speed Mint");
const u8 gText_NeutralMints[] =_("Neutral Mint");
...
const u8 gText_EVO_LEVEL_NATURE_MIDNIGHT[]          = _("LvlUp to {STR_VAR_2} with Midnight Nature");
const u8 gText_EVO_LEVEL_NATURE_MIDDAY[]            = _("LvlUp to {STR_VAR_2} with Midday Nature");
const u8 gText_EVO_LEVEL_NATURE_DUSK[]              = _("LvlUp to {STR_VAR_2} with Dusk Nature");
const u8 gText_EVO_LEVEL_NATURE_LOW_KEY[]           = _("LvlUp to {STR_VAR_2} with Low-Key Nature");
const u8 gText_EVO_LEVEL_NATURE_AMPED[]             = _("LvlUp to {STR_VAR_2} with Amped Nature");
