...
static const u8 sSandVeilDescription[] = _("Takes less damage in sand.");
...
static const u8 sMagmaArmorDescription[] = _("Prevents freeze and crits.");
...
static const u8 sSnowCloakDescription[] = _("Takes less damage in hail.");
