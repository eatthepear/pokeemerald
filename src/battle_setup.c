...
void BattleSetup_StartLegendaryBattle(void) //only capturable legendaries
{
    ...
    case SPECIES_MEW:
        ...
        break;
    case SPECIES_CELEBI:
        CreateBattleStartTask(B_TRANSITION_WHITE_BARS_FADE, MUS_C_VS_LEGEND_BEAST);
        break;
...
u8 BattleSetup_GetTerrainId(void)
{
    ...
    if (MetatileBehavior_IsLongGrass(tileBehavior) || MetatileBehavior_IsDarkLongGrass(tileBehavior))
