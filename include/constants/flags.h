...
#define FLAG_HIDDEN_ITEM_ZONE2B_ORAN_BERRY                   (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_ZONE2B_PECHA_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_ZONE3A_ORAN_BERRY                   (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_ZONE3A_PECHA_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_ZONE3A_CHERI_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_HIDDEN_ITEM_ZONE4A_ORAN_BERRY                   (FLAG_HIDDEN_ITEMS_START + 0x24)
#define FLAG_HIDDEN_ITEM_ZONE4A_PECHA_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_ZONE4C_ORAN_BERRY                   (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_ZONE4C_RAWST_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_ZONE4E_CHERI_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_ZONE6A_ORAN_BERRY                   (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_ZONE6A_CHERI_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_ZONE6A_PECHA_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_ZONE6A_RAWST_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_ZONE6A_PERSIM_BERRY                 (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_ZONE6A_CHESTO_BERRY                 (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_ZONE7A_ASPEAR_BERRY                 (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_ZONE7A_CHESTO_BERRY                 (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_ZONE7A_CHERI_BERRY                  (FLAG_HIDDEN_ITEMS_START + 0x18)
#define FLAG_HIDDEN_ITEM_ZONE7A_SITRUS_BERRY                 (FLAG_HIDDEN_ITEMS_START + 0x19)
#define FLAG_HIDDEN_ITEM_ZONE8A_ICE_GEM                      (FLAG_HIDDEN_ITEMS_START + 0x1A)
#define FLAG_HIDDEN_ITEM_ZONE8A_BUG_GEM                      (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_ZONE8A_POISON_GEM                   (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_ZONE8A_FIRE_GEM                     (FLAG_HIDDEN_ITEMS_START + 0x1F)
...
#define FLAG_ITEM_ZONE7A_SHARP_BEAK                                 0x3F8
...
#define FLAG_ITEM_ZONE8C_NEST_BALL                                  0x407
