const struct Trainer gTrainers[] = {
    ...
    [TRAINER_JOEY_LEVIATHAN_2] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_KNOWLEDGABLE | AI_FLAG_PREFER_STRONGEST_MOVE,
    ...
    [TRAINER_PHILLIPA_LEVIATHAN_3] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_KNOWLEDGABLE | AI_FLAG_PREFER_STRONGEST_MOVE,
        .partySize = ARRAY_COUNT(sParty_Phillipa),
        .party = {.TrainerMon = sParty_Phillipa},
        .hasCustomTransition = TRUE,
        .transition = B_TRANSITION_MUGSHOT,
    },
    ...
    [TRAINER_UNUSED4] =
    {
        ...
        // .partySize = ARRAY_COUNT(sParty_Unused4),
        .party = {.TrainerMon = sParty_Unused},
        // .party = {.TrainerMon = sParty_Unused4},
    },
    ...
    [TRAINER_UNUSED5] =
    {
        ...
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Unused),
        // .partySize = ARRAY_COUNT(sParty_Unused5),
        .party = {.TrainerMon = sParty_Unused},
        // .party = {.TrainerMon = sParty_Unused5},
    },
    ...
    [TRAINER_NATEY] =
    {
        ...
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE,
        .partySize = ARRAY_COUNT(sParty_Unused),
        // .partySize = ARRAY_COUNT(sParty_Natey),
        .party = {.TrainerMon = sParty_Unused},
        // .party = {.TrainerMon = sParty_Natey},
    },
