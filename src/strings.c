...
const u8 gText_EVO_LEVEL_MIDNIGHT[]                 = _("LvlUp to {STR_VAR_2}, Midnight persona");
const u8 gText_EVO_LEVEL_MIDDAY[]                   = _("LvlUp to {STR_VAR_2}, Midday persona");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("LvlUp to {STR_VAR_2}, Dusk persona");
