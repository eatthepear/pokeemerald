...
{
    FLAG_BEATLEVIATHAN1, FLAG_BEATLEVIATHAN2, FLAG_BEATLEVIATHAN4, FLAG_BEATLEVIATHAN6, FLAG_BEATLEVIATHAN9, FLAG_BEATLEVIATHAN10, FLAG_BEATLEVIATHAN11
};

const u16 sLevelCaps[NUM_SOFT_CAPS] = { 10, 12, 16, 18, 23, 25, 25};
