...
static bool8 Task_ProcessSoundCheckMenuInput(u8 taskId) // sub_080E8688
{
    ...
    else if (JOY_REPEAT(DPAD_LEFT))
    {
        ...
        else
        {
            if (gTasks[taskId].tBgmIndex > 0)
                ...
                gTasks[taskId].tBgmIndex = (MUS_BW_SEQ_BGM_GEAR_STATION - (MUS_LITTLEROOT_TEST - 1));
        }
        return TRUE;
    }
    else if (JOY_REPEAT(DPAD_RIGHT))
    {
        ...
        {
            if (gTasks[taskId].tBgmIndex < (MUS_BW_SEQ_BGM_GEAR_STATION - (MUS_LITTLEROOT_TEST - 1)))
                gTasks[taskId].tBgmIndex++;
            else
                gTasks[taskId].tBgmIndex = 0;
        }
...
#define SOUND_LIST_BGM \
    ...
    X(MUS_BW_SEQ_BGM_T_02_VAR1        , "BW-SEQ-BGM-T-02-VAR1") \
    X(MUS_BW_SEQ_BGM_T_02_VAR2        , "BW-SEQ-BGM-T-02-VAR2") \
    X(MUS_BW_SEQ_BGM_T_02_VAR3        , "BW-SEQ-BGM-T-02-VAR3") \
    ...
    X(MUS_BW_SEQ_BGM_WIN4             , "BW-SEQ-BGM-WIN4") \
    ...
    X(MUS_BW_SEQ_BGM_C_02_VAR         , "BW-SEQ-BGM-C-02-VAR") \
    ...
    X(MUS_BW_SEQ_BGM_C_07_VAR         , "BW-SEQ-BGM-C-07-VAR") \
    ...
    X(MUS_BW_SEQ_BGM_C_08_B_VAR       , "BW-SEQ-BGM-C-08-B-VAR") \
    X(MUS_BW_SEQ_BGM_C_08_B           , "BW-SEQ-BGM-C-08-B") \
    X(MUS_BW_SEQ_BGM_C_08_W_VAR       , "BW-SEQ-BGM-C-08-W-VAR") \
    X(MUS_BW_SEQ_BGM_C_08_W           , "BW-SEQ-BGM-C-08-W") \
    X(MUS_BW_SEQ_BGM_R_F              , "BW-SEQ-BGM-R-F") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR1 , "BW-SEQ-BGM-D-CHAMPROAD-VAR1") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR2 , "BW-SEQ-BGM-D-CHAMPROAD-VAR2") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR3 , "BW-SEQ-BGM-D-CHAMPROAD-VAR3") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR4 , "BW-SEQ-BGM-D-CHAMPROAD-VAR4") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR5 , "BW-SEQ-BGM-D-CHAMPROAD-VAR5") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR6 , "BW-SEQ-BGM-D-CHAMPROAD-VAR6") \
    X(MUS_BW_SEQ_BGM_D_CHAMPROAD_VAR7 , "BW-SEQ-BGM-D-CHAMPROAD-VAR7") \
